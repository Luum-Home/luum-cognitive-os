...
from cos_lib.config_loader import read_int_from_file as _cl_read_int_from_file
...
def _read_timeout_seconds(config_path: Optional[str] = None) -> int:
    ...
    Delegates to :func:`cos_lib.config_loader.read_int_from_file` via a
    ...
    * **dead**     — task has a ``pid`` field and that PID no longer exists
    ...
    def _enqueue_to_dispatch(self, task: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            from cos_lib.queue_drainer import QueueDrainer  # type: ignore[import]
    ...
    def _send_to_dlq(self, task: Dict[str, Any], reason: str) -> bool:
        ...
        try:
            ...
            from cos_lib.dead_letter_queue import DeadLetterQueue  # type: ignore[import]
