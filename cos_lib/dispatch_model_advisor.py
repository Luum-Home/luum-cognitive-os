...
from cos_lib.config_loader import find_config_path as _find_config_path
...
# _find_config_path is imported from cos_lib.config_loader (canonical implementation)
