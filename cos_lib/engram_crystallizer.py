...
from cos_lib import engram_client as _cli_mod_default
from cos_lib import engram_http_client as _http_mod_default
from cos_lib.engram_lifecycle import EngramLifecycle, _parse_iso8601_utc
...
class EngramCrystallizer:
    ...
    def synthesize_content(self, observations: list[dict[str, Any]]) -> str:
        ...
        for obs in observations:
            ...
            from cos_lib.engram_lifecycle import _TRAILER_RE
