...
This module wraps ``cos_lib.engram_client`` to add lifecycle metadata to every
...
NOT (cross-reference)
----------------------
This module does NOT replace ``cos_lib.engram_client``.  It wraps it.  Direct
...
# Allow both `from cos_lib.engram_lifecycle import ...` and direct execution
_LIB_DIR = os.path.dirname(os.path.abspath(__file__))
if _LIB_DIR not in sys.path:
    sys.path.insert(0, os.path.dirname(_LIB_DIR))

from cos_lib import engram_client  # noqa: E402 (after sys.path setup)
from cos_lib import engram_http_client  # noqa: E402 (after sys.path setup)
from cos_lib.memory_governance import assess_freshness, get_policy  # noqa: E402 (ADR-261)
