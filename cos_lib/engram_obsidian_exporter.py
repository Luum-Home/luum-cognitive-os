...
SQLite in read-only mode, mirroring ``cos_lib.engram_graph_walker``.
"""
...
from cos_lib import engram_http_client as _http_default  # noqa: E402
from cos_lib.engram_lifecycle import EngramLifecycle  # noqa: E402
