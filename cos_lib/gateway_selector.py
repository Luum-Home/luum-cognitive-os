...
Usage:
    from cos_lib.gateway_selector import select_gateway, get_gateway_status
...
from cos_lib.execution_profile import ExecutionProfile
...
def select_gateway(
    ...
    from cos_lib.litellm_client import CLAUDE_MODELS
    ...
    if "bifrost" not in excluded:
        from cos_lib.bifrost_client import is_model_bifrost_routable
    ...
    if "litellm" not in excluded:
        from cos_lib.litellm_client import is_model_litellm_routable
