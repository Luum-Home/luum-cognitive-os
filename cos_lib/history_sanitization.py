...
def execute(
    ...
    *,
    ...
    try:
        from cos_lib.release_freeze import assert_history_sanitize_allowed
    ...
    try:
        from cos_lib.history_rewrite_ledger import LedgerEntry, append_entry  # local import to avoid cycles
