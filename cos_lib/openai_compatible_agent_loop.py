...
def _tool_run_bash(args: Dict[str, Any]) -> str:
    ...
    try:
        from cos_lib.smart_truncator import smart_truncate
...
def _tool_web_fetch(args: Dict[str, Any]) -> str:
    ...
    timeout_s = max(1, min(timeout_s, 120))
    try:
        from cos_lib.web_crawler import fetch_markdown_sync
    ...
    try:
        from cos_lib.smart_truncator import _head_tail
...
def run_agent(
    ...
    *,
    ...
    try:
        from cos_lib.qwen_context_injector import compose_system_prompt
