...
Any code that imported from this module continues to work unchanged:
    from cos_lib.qwen_agent_loop import run_agent, AgentLoopResult
    from cos_lib.qwen_agent_loop import TOOL_SCHEMAS, ALL_TOOL_NAMES, TOOL_IMPLS

Reference: docs/02-Decisions/adrs/ADR-062-multi-provider-agent-loop.md (Phase 1)
"""

from cos_lib.openai_compatible_agent_loop import (  # noqa: F401 — re-export for backward compat
    AgentLoopResult,
    ALL_TOOL_NAMES,
    BASH_BLOCKLIST,
...
from cos_lib import qwen_provider as _qp
...
def run_agent(
    ...
    *,
    ...
    """
    from cos_lib.openai_compatible_agent_loop import run_agent as _run
    return _run(
        task=task,
        provider="qwen",
