...
Usage from CronCreate prompt:
    python3 -c "from cos_lib.scheduled_drain import drain_and_report; print(drain_and_report())"
...
def get_cron_create_spec() -> Dict[str, Any]:
    ...
    return {
        ...
        "prompt": (
            ...
            "1. Run: python3 -c \"from cos_lib.scheduled_drain import drain_and_report; "
...
def _get_health_report(tasks_path: str | None = None) -> str:
    ...
    try:
        from cos_lib.agent_health_monitor import AgentHealthMonitor  # type: ignore[import]
