...
Design contract
---------------
- Vendor-neutral: dispatch goes through :mod:`cos_lib.dispatch` (ADR-049 cascade —
...
# ---------------------------------------------------------------------------
# Dispatch wrapper (lazy import of cos_lib.dispatch)
# ---------------------------------------------------------------------------


def _default_dispatch(prompt: str) -> dict[str, Any]:
    """Thin wrapper around :func:`cos_lib.dispatch.dispatch`.
    ...
    """
    from cos_lib.dispatch import dispatch  # local import — keeps cold path cheap
