...
Usage:
    from cos_lib.trust_report_parser import TrustReportParser
...
from cos_lib.trust_report_schema import TrustReport, score_to_status
...
class TrustReportParser:
    ...
    Returns validated :class:`cos_lib.trust_report_schema.TrustReport` instances.
