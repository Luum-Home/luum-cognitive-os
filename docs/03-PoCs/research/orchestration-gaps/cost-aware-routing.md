...
5. [OpenRouter Provider Selection](https://openrouter.ai/docs/guides/routing/provider-selection)
...
9. [Prompt caching — Aider](https://aider.chat/docs/usage/caching.html)
