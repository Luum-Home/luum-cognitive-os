...
| Metric | Count | Notes |
|---|---|---|
| Total hook files on disk (`hooks/*.sh`) | **257** | Flat invocable hook scripts under `hooks/`; refreshed after adding the portable conflict marker guard and projection metadata repairs. |
