...
| Metric | Count | Notes |
|---|---|---|
| Total hook files on disk (`hooks/*.sh`) | **239** | Flat invocable hook scripts under `hooks/`; refreshed after adding skill-drift and stack-recommendation SessionStart hooks. |
