...
- [Host Tooling and Engram MCP Verification](../../09-Quality/manual-tests/host-tooling-engram-mcp-verification.md)
- [Testing Guide](../../09-Quality/root/testing.md)
- [ADR-071: Engram Lifecycle Evolution](../../02-Decisions/adrs/ADR-071-engram-lifecycle-evolution.md)
