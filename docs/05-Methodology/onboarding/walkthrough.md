...
[pre-public-readiness checklist](../../09-Quality/legal/pre-public-readiness-checklist.md).
...
| Goal | File |
|------|------|
| Detailed setup, dependency matrix | [`docs/00-MOCs/entrypoints/getting-started.md`](../../00-MOCs/entrypoints/getting-started.md) |
| Migrating from stock Claude Code | [`docs/08-References/migration-from/from-vanilla-claude-code.md`](../../08-References/migration-from/from-vanilla-claude-code.md) |
| Architecture decisions | [`docs/02-Decisions/adrs/`](../adrs/) (start with ADR-001, ADR-093, ADR-131) |
| All the demo paths | [`docs/09-Quality/manual-tests/proof-paths.md`](../../09-Quality/manual-tests/proof-paths.md) |
| Why-not-X comparison | [`docs/08-References/root/vs-alternatives.md`](../../08-References/root/vs-alternatives.md) |
| Public-readiness audit | [`docs/09-Quality/legal/pre-public-readiness-checklist.md`](../../09-Quality/legal/pre-public-readiness-checklist.md) |
