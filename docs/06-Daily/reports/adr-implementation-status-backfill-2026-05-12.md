...
| [217](../adrs/ADR-217-cross-stack-adoption-truth-audit.md) | `accepted` | `partial` | implementation evidence plus partial/deferred/future signal | **Source**: Operator question — *"analysis is missing on whether it is already adopted and how (this should also be in the primitives)"* |
| [218](../adrs/ADR-218-history-sanitization-toolchain.md) | `accepted` | `partial` | implementation evidence plus partial/deferred/future signal | **Source**: Operator question — *"how do we clean what is in git about sensitive data and these license changes without creating a new repo?"* |
