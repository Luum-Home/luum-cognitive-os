# Aspirational Audit — 2026-07-09

## Summary

| Metric | Value |
|--------|-------|
| Total components | 1278 |
| REAL | 351 |
| DORMANT | 3 |
| ASPIRATIONAL | 0 |
| METADATA | 89 |
| DORMANT + ASPIRATIONAL ratio | 0.2% |

## Worst Offenders (ASPIRATIONAL + DORMANT)

- `scripts/adr_kb_benchmark.py`
- `scripts/cos_lib_rename_codemod.py`
...
| `hooks/adaptive-bypass.sh` | REAL | fire_count_7d=33, registered=True | fires actively (33 rows in hook-health.jsonl last 7d) |
...
| `hooks/adversarial-review-gate.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
...
| `hooks/agent-launch-confirmed.sh` | REAL | fire_count_7d=33, registered=True | fires actively (33 rows in hook-health.jsonl last 7d) |
...
| `hooks/assumption-tracker.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
...
| `hooks/auto-repair-dispatcher.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
| `hooks/auto-rollback-trigger.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
...
| `hooks/blast-radius.sh` | REAL | fire_count_7d=33, registered=True | fires actively (33 rows in hook-health.jsonl last 7d) |
...
| `hooks/claim-validator.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
| `hooks/clarification-gate.sh` | REAL | fire_count_7d=33, registered=True | fires actively (33 rows in hook-health.jsonl last 7d) |
...
| `hooks/codebase-itinerary-capture.sh` | REAL | fire_count_7d=676, registered=True | fires actively (676 rows in hook-health.jsonl last 7d) |
...
| `hooks/confidence-gate.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
...
| `hooks/decision-depth-gate.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
...
| `hooks/destructive-git-blocker.sh` | REAL | fire_count_7d=129, registered=True | fires actively (129 rows in hook-health.jsonl last 7d) |
| `hooks/destructive-rm-blocker.sh` | REAL | fire_count_7d=44, registered=True | fires actively (44 rows in hook-health.jsonl last 7d) |
| `hooks/direct-main-guard.sh` | REAL | fire_count_7d=139, registered=True | fires actively (139 rows in hook-health.jsonl last 7d) |
...
| `hooks/doc-sync-detector.sh` | REAL | fire_count_7d=498, registered=True | fires actively (498 rows in hook-health.jsonl last 7d) |
...
| `hooks/engram-obsidian-export-on-stop.sh` | REAL | fire_count_7d=141, registered=True | fires actively (141 rows in hook-health.jsonl last 7d) |
...
| `hooks/error-learning.sh` | REAL | fire_count_7d=1038, registered=True | fires actively (1038 rows in hook-health.jsonl last 7d) |
...
| `hooks/error-pipeline.sh` | REAL | fire_count_7d=1038, registered=True | fires actively (1038 rows in hook-health.jsonl last 7d) |
...
| `hooks/kpi-trigger.sh` | REAL | fire_count_7d=141, registered=True | fires actively (141 rows in hook-health.jsonl last 7d) |
| `hooks/large-file-advisor.sh` | REAL | fire_count_7d=676, registered=True | fires actively (676 rows in hook-health.jsonl last 7d) |
...
| `hooks/post-agent-snapshot-restore.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
| `hooks/post-agent-verify.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
| `hooks/post-git-orphan-notifier.sh` | REAL | fire_count_7d=1038, registered=True | fires actively (1038 rows in hook-health.jsonl last 7d) |
...
| `hooks/protected-config-write-guard.sh` | REAL | fire_count_7d=2885, registered=True | fires actively (2885 rows in hook-health.jsonl last 7d) |
...
| `hooks/reinvention-check.sh` | REAL | fire_count_7d=36, registered=True | fires actively (36 rows in hook-health.jsonl last 7d) |
...
| `hooks/result-truncator.sh` | REAL | fire_count_7d=1038, registered=True | fires actively (1038 rows in hook-health.jsonl last 7d) |
| `hooks/review-spawner.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
...
| `hooks/secret-detector.sh` | REAL | fire_count_7d=1687, registered=True | fires actively (1687 rows in hook-health.jsonl last 7d) |
...
| `hooks/session-learning.sh` | REAL | fire_count_7d=141, registered=True | fires actively (141 rows in hook-health.jsonl last 7d) |
...
| `hooks/session-start-worktree-nudge.sh` | REAL | fire_count_7d=5, registered=True | fires actively (5 rows in hook-health.jsonl last 7d) |
...
| `hooks/skill-feedback-tracker.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
...
| `hooks/skill-router-bash-gate.sh` | REAL | fire_count_7d=1, registered=True | fires actively (1 rows in hook-health.jsonl last 7d) |
...
| `hooks/skill-synthesis-scanner.sh` | REAL | fire_count_7d=141, registered=True | fires actively (141 rows in hook-health.jsonl last 7d) |
| `hooks/skill-tracker.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
...
| `hooks/so-impact-eval-trigger.sh` | REAL | fire_count_7d=0, registered=True, writes_jsonl=True | registered + writes metrics JSONL (fires may be outside 7d window) |
...
| `hooks/surface-fix-detector.sh` | REAL | fire_count_7d=498, registered=True | fires actively (498 rows in hook-health.jsonl last 7d) |
...
| `hooks/tool-sequence-capture.sh` | REAL | fire_count_7d=2492, registered=True | fires actively (2492 rows in hook-health.jsonl last 7d) |
| `hooks/trust-score-validator.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
| `hooks/untracked-work-preservation-guard.sh` | REAL | fire_count_7d=118, registered=True | fires actively (118 rows in hook-health.jsonl last 7d) |
...
| `hooks/work-queue-sync.sh` | REAL | fire_count_7d=32, registered=True | fires actively (32 rows in hook-health.jsonl last 7d) |
...
| `lib/agent_bus.py` | REAL | callers=5, size_bytes=37404 | imported by 5 non-test caller(s) |
| `lib/agent_bus_metrics.py` | REAL | callers=7, size_bytes=15445 | imported by 7 non-test caller(s) |
...
| `lib/agent_health_monitor.py` | REAL | callers=2, size_bytes=16965 | imported by 2 non-test caller(s) |
| `lib/agent_input_validator.py` | REAL | callers=1, size_bytes=7893 | imported by 1 non-test caller(s) |
...
| `lib/agent_spawn_benchmark.py` | REAL | callers=0, writes_jsonl=True, size_bytes=20854 | writes to an existing metrics JSONL file |
...
| `lib/ai_provider_identity_guard.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=9866 | covered by test — legit sleeper (imported by test only) |
...
| `lib/auto_repair.py` | REAL | callers=2, size_bytes=23819 | imported by 2 non-test caller(s) |
...
| `lib/capability_ceiling.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=4746 | covered by test — legit sleeper (imported by test only) |
...
| `lib/circuit_breaker.py` | REAL | callers=3, size_bytes=8181 | imported by 3 non-test caller(s) |
| `lib/claude_executor.py` | REAL | callers=8, size_bytes=37590 | imported by 8 non-test caller(s) |
...
| `lib/compat_tomllib.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=4101 | covered by test — legit sleeper (imported by test only) |
| `lib/compatibility_layer.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=9023 | covered by test — legit sleeper (imported by test only) |
...
| `lib/concurrency_safety.py` | REAL | callers=8, size_bytes=6331 | imported by 8 non-test caller(s) |
| `lib/concurrent_agent_safety_status.py` | REAL | callers=1, size_bytes=11115 | imported by 1 non-test caller(s) |
| `lib/confidentiality_scanner.py` | REAL | callers=1, size_bytes=13211 | imported by 1 non-test caller(s) |
...
| `lib/context_budget.py` | REAL | callers=4, size_bytes=5706 | imported by 4 non-test caller(s) |
...
| `lib/context_injector.py` | REAL | callers=3, size_bytes=21315 | imported by 3 non-test caller(s) |
| `lib/cosd_auth_guard.py` | REAL | callers=1, size_bytes=6213 | imported by 1 non-test caller(s) |
| `lib/cosd_grant.py` | REAL | callers=1, size_bytes=10033 | imported by 1 non-test caller(s) |
...
| `lib/cross_stack_adoption_truth.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=12574 | covered by test — legit sleeper (imported by test only) |
| `lib/cross_stack_license_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=8437 | covered by test — legit sleeper (imported by test only) |
| `lib/cross_stack_secret_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=13090 | covered by test — legit sleeper (imported by test only) |
| `lib/cross_verifier.py` | REAL | callers=1, size_bytes=10720 | imported by 1 non-test caller(s) |
| `lib/dead_letter_queue.py` | REAL | callers=2, size_bytes=6804 | imported by 2 non-test caller(s) |
| `lib/decision_tracker.py` | REAL | callers=3, size_bytes=4251 | imported by 3 non-test caller(s) |
| `lib/deferred_tool_loading.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=12395 | covered by test — legit sleeper (imported by test only) |
...
| `lib/dependency_adoption_gate.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=7938 | covered by test — legit sleeper (imported by test only) |
| `lib/dependency_coverage_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=24972 | covered by test — legit sleeper (imported by test only) |
...
| `lib/dispatch.py` | REAL | callers=16, size_bytes=44802 | imported by 16 non-test caller(s) |
...
| `lib/dogfood_scorer.py` | REAL | callers=1, size_bytes=27383 | imported by 1 non-test caller(s) |
| `lib/domain_model.py` | REAL | callers=1, size_bytes=4238 | imported by 1 non-test caller(s) |
| `lib/domain_router.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=21339 | covered by test — legit sleeper (imported by test only) |
| `lib/dspy_pilot.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=1330 | covered by test — legit sleeper (imported by test only) |
| `lib/duplicate_scanner.py` | REAL | callers=2, size_bytes=12619 | imported by 2 non-test caller(s) |
...
| `lib/engram_claims.py` | REAL | callers=5, size_bytes=7807 | imported by 5 non-test caller(s) |
...
| `lib/engram_http_client.py` | REAL | callers=2, size_bytes=12053 | imported by 2 non-test caller(s) |
| `lib/engram_lifecycle.py` | REAL | callers=1, size_bytes=30313 | imported by 1 non-test caller(s) |
| `lib/engram_locks.py` | REAL | callers=5, size_bytes=9198 | imported by 5 non-test caller(s) |
...
| `lib/estimation_calibrator.py` | REAL | callers=4, size_bytes=15374 | imported by 4 non-test caller(s) |
...
| `lib/ground_truth.py` | REAL | callers=3, size_bytes=16340 | imported by 3 non-test caller(s) |
...
| `lib/history_rewrite_ledger.py` | REAL | callers=2, size_bytes=9782 | imported by 2 non-test caller(s) |
...
| `lib/improve_loop.py` | REAL | callers=1, size_bytes=14017 | imported by 1 non-test caller(s) |
...
| `lib/jupyter_client.py` | REAL | callers=1, size_bytes=9374 | imported by 1 non-test caller(s) |
...
| `lib/maintainer_impact.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=13551 | covered by test — legit sleeper (imported by test only) |
...
| `lib/manifest_loader.py` | REAL | callers=3, size_bytes=16060 | imported by 3 non-test caller(s) |
...
| `lib/memory.py` | REAL | callers=1, size_bytes=2593 | imported by 1 non-test caller(s) |
...
| `lib/metric_event.py` | REAL | callers=15, size_bytes=6070 | imported by 15 non-test caller(s) |
| `lib/mlflow_bridge.py` | REAL | callers=1, size_bytes=10469 | imported by 1 non-test caller(s) |
| `lib/model_catalog.py` | REAL | callers=1, size_bytes=17791 | imported by 1 non-test caller(s) |
...
| `lib/notifications.py` | REAL | callers=2, size_bytes=12167 | imported by 2 non-test caller(s) |
...
| `lib/paths.py` | REAL | callers=4, size_bytes=8482 | imported by 4 non-test caller(s) |
...
| `lib/performance_ledger.py` | REAL | callers=0, writes_jsonl=True, size_bytes=21481 | writes to an existing metrics JSONL file |
...
| `lib/portability_proof_paths.py` | REAL | callers=2, size_bytes=4904 | imported by 2 non-test caller(s) |
| `lib/prelaunch_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=36034 | covered by test — legit sleeper (imported by test only) |
| `lib/primitive_contracts.py` | REAL | callers=2, size_bytes=1822 | imported by 2 non-test caller(s) |
| `lib/primitive_file_inventory.py` | REAL | callers=2, size_bytes=1370 | imported by 2 non-test caller(s) |
| `lib/primitive_fitness.py` | REAL | callers=1, size_bytes=20718 | imported by 1 non-test caller(s) |
| `lib/primitive_parser.py` | REAL | callers=5, size_bytes=20190 | imported by 5 non-test caller(s) |
...
| `lib/project_paths.py` | REAL | callers=21, size_bytes=1228 | imported by 21 non-test caller(s) |
...
| `lib/promote_from_telemetry.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=29666 | covered by test — legit sleeper (imported by test only) |
...
| `lib/publication_safety.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=13559 | covered by test — legit sleeper (imported by test only) |
...
| `lib/queue_drainer.py` | REAL | callers=4, size_bytes=21243 | imported by 4 non-test caller(s) |
...
| `lib/qwen_agent_loop.py` | REAL | callers=1, size_bytes=2125 | imported by 1 non-test caller(s) |
...
| `lib/rate_limit_protection.py` | REAL | callers=1, size_bytes=863 | imported by 1 non-test caller(s) |
...
| `lib/record_completion.py` | REAL | callers=2, size_bytes=20007 | imported by 2 non-test caller(s) |
...
| `lib/release_analyzer.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=20848 | covered by test — legit sleeper (imported by test only) |
| `lib/release_freeze.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=17543 | covered by test — legit sleeper (imported by test only) |
...
| `lib/script_helpers.py` | REAL | callers=52, size_bytes=4093 | imported by 52 non-test caller(s) |
| `lib/script_io.py` | REAL | callers=30, size_bytes=2690 | imported by 30 non-test caller(s) |
...
| `lib/semantic_skill_matcher.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=24156 | covered by test — legit sleeper (imported by test only) |
...
| `lib/skill_drift_detector.py` | REAL | callers=2, size_bytes=9448 | imported by 2 non-test caller(s) |
...
| `lib/skill_router.py` | REAL | callers=5, size_bytes=75918 | imported by 5 non-test caller(s) |
...
| `lib/smart_infra.py` | REAL | callers=6, size_bytes=23363 | imported by 6 non-test caller(s) |
| `lib/smart_reader.py` | REAL | callers=0, writes_jsonl=True, size_bytes=24539 | writes to an existing metrics JSONL file |
| `lib/smart_truncator.py` | REAL | callers=2, size_bytes=20808 | imported by 2 non-test caller(s) |
| `lib/smoke_report_cli.py` | REAL | callers=2, size_bytes=1467 | imported by 2 non-test caller(s) |
...
| `lib/stash_provenance.py` | REAL | callers=2, size_bytes=10475 | imported by 2 non-test caller(s) |
...
| `lib/symbiosis_monitor.py` | REAL | callers=1, size_bytes=15958 | imported by 1 non-test caller(s) |
...
| `lib/telemetry_aggregator.py` | REAL | callers=1, size_bytes=24108 | imported by 1 non-test caller(s) |
| `lib/telemetry_banner.py` | REAL | callers=1, size_bytes=4041 | imported by 1 non-test caller(s) |
| `lib/test_efficiency_planner.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=7224 | covered by test — legit sleeper (imported by test only) |
...
| `lib/time_utils.py` | REAL | callers=5, size_bytes=711 | imported by 5 non-test caller(s) |
| `lib/token_budget_monitor.py` | REAL | callers=1, size_bytes=12964 | imported by 1 non-test caller(s) |
| `lib/token_usage.py` | REAL | callers=1, size_bytes=9290 | imported by 1 non-test caller(s) |
...
| `lib/tool_budget_catalog.py` | REAL | callers=2, size_bytes=3069 | imported by 2 non-test caller(s) |
...
| `lib/tool_replay_ledger.py` | REAL | callers=4, size_bytes=15693 | imported by 4 non-test caller(s) |
...
| `lib/trace_joiner.py` | REAL | callers=0, writes_jsonl=True, size_bytes=12811 | writes to an existing metrics JSONL file |
...
| `lib/wiring_validator.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=16809 | covered by test — legit sleeper (imported by test only) |
...
| `scripts/acc_pipeline.py` | REAL | writes_jsonl=True, size_bytes=77554 | writes to an existing metrics JSONL file |
...
| `scripts/adr100_live_headroom_check.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=8659 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/adr_implementation_ledger.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=22770 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/adr_kb_benchmark.py` | DORMANT | callers=0, size_bytes=12262 | no observable production use, no test, no on-demand marker |
...
| `scripts/agent-orchestration-benchmark.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=4642 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/agent-orchestration-boundary-audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=11940 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/aggregate_session_tokens.py` | REAL | writes_jsonl=True, size_bytes=10872 | writes to an existing metrics JSONL file |
...
| `scripts/aspirational_audit.py` | REAL | writes_jsonl=True, size_bytes=40615 | writes to an existing metrics JSONL file |
...
| `scripts/claim_task.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=3943 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/compose_agent_prompt.py` | ON_DEMAND | callers=0, on_demand_marker=True, size_bytes=8504 | @on-demand marker — legit rarely-invoked script |
| `scripts/context_budget_meter_fast.py` | REAL | writes_jsonl=True, size_bytes=4148 | writes to an existing metrics JSONL file |
| `scripts/cos-adr-implementation-audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=5678 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-closure-trust-signal.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=6796 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-doc-cross-reference-audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=7481 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-doctor-harness.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=10739 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-filter-repo-wrap.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=10843 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-merge-queue-worker.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=17156 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-operational-guide-audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=12020 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-status.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=39731 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/cos-subprocess-timeout-audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=6155 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_agent_flicker_report.py` | REAL | writes_jsonl=True, size_bytes=26864 | writes to an existing metrics JSONL file |
| `scripts/cos_agent_message.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=4313 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_classify_coverage.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=9285 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_cleanup_preserved_wip.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=15133 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_credential_safe_run.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=11163 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_deps_install.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=12782 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_doc_path_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=19072 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_executor.py` | REAL | writes_jsonl=True, size_bytes=14635 | writes to an existing metrics JSONL file |
...
| `scripts/cos_governance_roi.py` | REAL | writes_jsonl=True, size_bytes=28340 | writes to an existing metrics JSONL file |
...
| `scripts/cos_improve.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=2767 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/cos_init.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=87649 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_lib_rename_codemod.py` | DORMANT | callers=0, size_bytes=16994 | no observable production use, no test, no on-demand marker |
...
| `scripts/cos_promotion_proposer.py` | REAL | writes_jsonl=True, size_bytes=13139 | writes to an existing metrics JSONL file |
...
| `scripts/cos_quality_duplicates.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=17077 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_remote_branch_triage.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=9531 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_self_improvement_loop.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=3056 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/cos_service_control_plane.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=25173 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/cos_session_backlog.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=33851 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/cos_session_coordination.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=6402 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_sprint.py` | REAL | writes_jsonl=True, size_bytes=14536 | writes to an existing metrics JSONL file |
| `scripts/cos_task_claims.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=18479 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_watch.py` | REAL | writes_jsonl=True, size_bytes=11992 | writes to an existing metrics JSONL file |
...
| `scripts/cos_worktree_triage.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=11131 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/decision_triage.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=34584 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/derived_artifact_gate.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=7196 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/documentation_truth_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=13882 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/english_only_content_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=32781 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/hook-timing-wrapper.sh` | REAL | writes_jsonl=True, size_bytes=20095 | writes to an existing metrics JSONL file |
...
| `scripts/lib_closure.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=7575 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/merge-to-main.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=8528 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/migrate_skill_archive_to_store.py` | REAL | writes_jsonl=True, size_bytes=8304 | writes to an existing metrics JSONL file |
...
| `scripts/opencode_primitive_adapter_smoke.py` | REAL | writes_jsonl=True, size_bytes=14352 | writes to an existing metrics JSONL file |
...
| `scripts/orchestrator_claim_gate.py` | REAL | writes_jsonl=True, size_bytes=18350 | writes to an existing metrics JSONL file |
| `scripts/orphan_commit_scan.py` | REAL | writes_jsonl=True, size_bytes=14049 | writes to an existing metrics JSONL file |
...
| `scripts/portable_ai_overlay.py` | REAL | writes_jsonl=True, size_bytes=25917 | writes to an existing metrics JSONL file |
...
| `scripts/primitive-behavior-audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=9309 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/primitive-coherence-audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=17678 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/primitive_authority_audit.py` | REAL | writes_jsonl=True, size_bytes=21746 | writes to an existing metrics JSONL file |
...
| `scripts/primitive_behavior_depth_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=9022 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/primitive_duplication_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=22370 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/primitive_family_readiness_ledger.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=16098 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/primitive_harness_coverage.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=30192 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/primitive_parse_inventory.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=2770 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/primitive_readiness_ledger.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=23642 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/primitive_scope_classifier.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=31159 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/primitive_service_headless_smoke.py` | REAL | writes_jsonl=True, size_bytes=4825 | writes to an existing metrics JSONL file |
...
| `scripts/private_content_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=16946 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/project_shell_ci.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=5052 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/proof_drill_evidence_record.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=3202 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/proof_drill_select.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=5510 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/push_collision_detect.py` | REAL | writes_jsonl=True, size_bytes=15371 | writes to an existing metrics JSONL file |
...
| `scripts/security_red_team.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=27294 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/self_programming_pattern_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=5249 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/skill-router-benchmark.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=4706 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/skill-router-retrieval-audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=7877 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/so_session_watchdog.py` | REAL | writes_jsonl=True, size_bytes=13260 | writes to an existing metrics JSONL file |
...
| `scripts/state_retention_audit.py` | REAL | writes_jsonl=True, size_bytes=22973 | writes to an existing metrics JSONL file |
...
| `scripts/subagent_launch_preflight.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=11178 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/token_report.py` | REAL | writes_jsonl=True, size_bytes=11177 | writes to an existing metrics JSONL file |
...
| `scripts/validate_okf.py` | DORMANT | callers=0, size_bytes=5020 | no observable production use, no test, no on-demand marker |
...
| `scripts/verify_plan_claims.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=4430 | covered by test — legit sleeper (test proves it works when called) |
