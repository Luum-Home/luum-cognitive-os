...
| `hooks/_lib/portable.sh` | runtime-safety | lifecycle | high | lifecycle-declared-consumer-candidate | candidate | 432 | prove consumer project projection per supported harness before promotion |
