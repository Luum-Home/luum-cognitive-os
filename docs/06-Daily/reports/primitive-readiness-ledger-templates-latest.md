...
| `templates/fintech-gates.md` | quality-gate | heuristic:text | medium | so-local-only |  | 7 | add lifecycle/package/projection metadata or keep SO-local |
...
| `templates/go-service-context.md` | prompt-composition | heuristic:text | medium | so-local-only |  | 6 | add lifecycle/package/projection metadata or keep SO-local |
