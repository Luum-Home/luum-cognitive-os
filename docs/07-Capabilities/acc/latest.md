...
- ACC: 0.9151
- ACC effective: 0.9155
- Total weight: 7670
- Capabilities: 3532
- Findings: 288
- Mapping weights: {'aligned': 7019, 'missing': 0, 'overexposed': 0, 'partial': 434, 'stale': 214, 'unverified': 3}
...
|---|---|---|---|
| authority_write_effects | ok | `docs/06-Daily/reports/primitive-authority-latest.json` | `{"block_count": 0, "by_mode": {"observe-only": 133, "os-maintainer-write": 509, "profile-projection-write": 37, "propose-only": 3}, "by_status": {"pass": 672, "warn": 10}, "dynamic_blocks": 0, "dynamic_smokes": 4, "total_scripts": 682}` |
...
| readiness:scripts | ok | `docs/06-Daily/reports/primitive-readiness-ledger-scripts-latest.json` | `{"agentic_primitives_without_lifecycle": 0, "confidence": {"high": 367, "low": 1, "medium": 315}, "consumer_accessibility": {"install-profile-managed": 19, "lifecycle-declared-consumer-candidate": 167, "lifecycle-declared-maintainer": 155, ` |
...
- lifecycle-declared-maintainer: 177
- maintainer-only: 315
- profile-driver: 19
- projected-consumer-surface: 1888
- runtime-evidence: 10
