...
Generated: 2026-06-12T20:40:54Z
...
- Capabilities: 3484
- Findings: 288
- Mapping weights: {'aligned': 6907, 'missing': 0, 'overexposed': 0, 'partial': 434, 'stale': 214, 'unverified': 3}
...
|---|---|---|---|
| authority_write_effects | ok | `docs/06-Daily/reports/primitive-authority-latest.json` | `{"block_count": 0, "by_mode": {"observe-only": 132, "os-maintainer-write": 494, "profile-projection-write": 37, "propose-only": 3}, "by_status": {"pass": 656, "warn": 10}, "dynamic_blocks": 0, "dynamic_smokes": 4, "total_scripts": 666}` |
...
| primitive_interventions | ok | `.cognitive-os/metrics/primitive-interventions.jsonl` | `{"actions": {"advise": 3, "allow": 19, "block": 137, "warn": 230}, "primitive_count": 9}` |
