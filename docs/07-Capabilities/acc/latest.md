...
Generated: 2026-06-16T13:28:42Z
...
- ACC: 0.9170
- ACC effective: 0.9174
- Total weight: 7855
- Capabilities: 3613
- Findings: 289
- Mapping weights: {'aligned': 7203, 'missing': 0, 'overexposed': 0, 'partial': 435, 'stale': 214, 'unverified': 3}
...
|---|---|---|---|
| authority_write_effects | ok | `docs/06-Daily/reports/primitive-authority-latest.json` | `{"block_count": 0, "by_mode": {"observe-only": 147, "os-maintainer-write": 520, "profile-projection-write": 37, "propose-only": 3}, "by_status": {"pass": 697, "warn": 10}, "dynamic_blocks": 0, "dynamic_smokes": 4, "total_scripts": 707}` |
...
| consumer_projection | ok | `consumer_projection` | `{"by_harness_profile": {"agents-md/default": 83, "agents-md/full": 400, "aider/default": 83, "aider/full": 400, "amp-code/default": 83, "amp-code/full": 400, "augment-code/default": 83, "augment-code/full": 400, "claude/default": 83, "claud` |
| cos_coverage | ok | `cos_coverage` | `{"aspirational": 0, "coverage_pct": 0.0, "dormant": 0, "generated_at": "2026-06-16T13:26:18Z", "mapped": 268, "metadata": 0, "on_demand": 0, "project": "<repo-root>", "real": 0, "tiers": {"A": 8, "B": 2, "C": 55, "D": 181}, "trend": {"cover` |
| docs_execution | ok | `docs_execution` | `{"items": 5831, "json": "<repo-root>/docs/06-Daily/reports/docs-execution-latest.json", "markdown": "<repo-root>/docs/06-Daily/reports/docs-execution-latest.md"}` |
...
| family_readiness_skills | ok | `family_readiness_skills` | `{"confidence": {"high": 109, "medium": 12}, "consumer_accessibility": {"lifecycle-declared-maintainer": 101, "projected-consumer-surface": 7, "repo-skill-not-projectable": 7, "so-local-only": 6}, "json": "<repo-root>/docs/06-Daily/reports/p` |
...
| harness_coverage | ok | `docs/06-Daily/reports/primitive-harness-coverage-latest.json` | `{"by_family": {"hooks": 287, "rules": 129, "scripts": 708, "skills": 121, "templates": 24}, "by_scope": {"None": 1, "both": 513, "os-only": 727, "project": 28}, "gap_policies": {"acceptable-claude-only": 4, "acceptable-codex-limited-tool-ev` |
| harness_coverage_refresh | ok | `harness_coverage_refresh` | `{"by_family": {"hooks": 287, "rules": 129, "scripts": 708, "skills": 121, "templates": 24}, "by_scope": {"None": 1, "both": 513, "os-only": 727, "project": 28}, "gaps": 366, "gaps_by_policy": {"acceptable-claude-only": 4, "acceptable-codex-` |
| harness_projection | ok | `manifests/harness-projection.yaml` | `{"implemented": 22, "planned": 5, "total": 27, "unsupported": 0}` |
| primitive_authority_audit | ok | `primitive_authority_audit` | `{"block_count": 0, "by_mode": {"observe-only": 147, "os-maintainer-write": 520, "profile-projection-write": 37, "propose-only": 3}, "by_status": {"pass": 697, "warn": 10}, "dynamic_blocks": 0, "dynamic_smokes": 4, "total_scripts": 707}` |
| primitive_duplication | ok | `primitive_duplication` | `{"by_common_home": {"lib/": 13}, "by_consumer_relevance": {"so-local-first": 13}, "by_kind": {"python-function-repeat": 13}, "files_scanned": 1038, "findings": 13}` |
...
| readiness:scripts | ok | `docs/06-Daily/reports/primitive-readiness-ledger-scripts-latest.json` | `{"agentic_primitives_without_lifecycle": 0, "confidence": {"high": 390, "low": 1, "medium": 317}, "consumer_accessibility": {"install-profile-managed": 19, "lifecycle-declared-consumer-candidate": 167, "lifecycle-declared-maintainer": 180, ` |
| readiness:skills | ok | `docs/06-Daily/reports/primitive-readiness-ledger-skills-latest.json` | `{"confidence": {"high": 109, "medium": 12}, "consumer_accessibility": {"lifecycle-declared-maintainer": 101, "projected-consumer-surface": 7, "repo-skill-not-projectable": 7, "so-local-only": 6}, "roles": {"compatibility-wrapper": 55, "lab"` |
...
- lifecycle-declared-maintainer: 202
- maintainer-only: 315
- profile-driver: 19
- projected-consumer-surface: 1916
- runtime-evidence: 10
