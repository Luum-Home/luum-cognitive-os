...
- Capabilities: 3683
- Findings: 288
- Mapping weights: {'aligned': 7351, 'missing': 0, 'overexposed': 0, 'partial': 434, 'stale': 214, 'unverified': 3}
...
| harness_coverage | ok | `docs/06-Daily/reports/primitive-harness-coverage-latest.json` | `{"by_family": {"hooks": 287, "rules": 129, "scripts": 730, "skills": 128, "templates": 24}, "by_scope": {"both": 524, "os-only": 746, "project": 28}, "gap_policies": {"acceptable-claude-only": 4, "acceptable-codex-limited-tool-events": 6, "` |
...
| primitive_interventions | ok | `.cognitive-os/metrics/primitive-interventions.jsonl` | `{"actions": {"advise": 3, "allow": 19, "block": 152, "warn": 256}, "primitive_count": 9}` |
...
| readiness:skills | ok | `docs/06-Daily/reports/primitive-readiness-ledger-skills-latest.json` | `{"confidence": {"high": 116, "medium": 12}, "consumer_accessibility": {"lifecycle-declared-maintainer": 105, "projected-consumer-surface": 9, "repo-skill-not-projectable": 7, "so-local-only": 7}, "roles": {"compatibility-wrapper": 63, "lab"` |
