---
adr: 179
title: Reserved architecture decision
status: tombstone
date: 2026-05-05
supersedes: []
superseded_by: null
...
---
# ADR-179: Reserved architecture decision
...
This ADR number is intentionally reserved so later local decision files remain contiguous.
...
Keep ADR-179 as a neutral tombstone. Do not reuse this number for a different
