...
| ADR-018 / ADR-042 / ADR-043 / ADR-045 / ADR-048 | Local daemons could read as reversing Docker-to-pip. | Local-daemon ADRs are explicitly continuations of ADR-018 phase 3. ADR-048 governs only remaining Docker fallback/reference surfaces. |
...
flowchart TD
  ...
  E --> F["ADR-042/043/045: local daemons"]
