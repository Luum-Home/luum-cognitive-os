...
|-----------|------|---------|
| Hook | `.cognitive-os/hooks/doc-sync-detector.sh` | PostToolUse on Edit/Write — detects stale docs |
...
| `.cognitive-os/hooks/*` | .cognitive-os/docs/hooks.md, overview.md |
...
```json
{
  ...
  "changed_file": "wallet/wallet-go/apps/wallet/infrastructure/controllers/wallet_controller.go",
...
| Hook (updated) | `.cognitive-os/hooks/coverage-gate.sh` | Phase-aware coverage gate on commit/push |
