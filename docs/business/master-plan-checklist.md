...
- [ ] Implement ADR-256 Primitive Contract Registry and Runtime Evidence Ledger in phases: minimal contract registry, intervention ledger, codebase itinerary, projection-fidelity report, trace-joiner integration, and consumer UX. Plan-first docs exist in [ADR-256](../adrs/ADR-256-primitive-contract-registry-and-runtime-evidence-ledger.md) and [Primitive Contract Registry Implementation Plan](../architecture/primitive-contract-registry-implementation-plan.md).
