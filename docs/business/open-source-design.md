...
| Service paths (`micro-services/users-core/`) | auto-test-on-edit.sh | Generated from `cognitive-os.yaml -> services` |
...
```bash
curl -fsSL https://raw.githubusercontent.com/cognitive-os/cognitive-os/main/install.sh | bash
```
