...
| WireMock, TestContainers | Referenced in `micro-services/` |
...
|---------|-------------|--------|
| users-core | `micro-services/users-core/` | Reminder only (Java too slow for auto-run) |
| users-auth | `micro-services/users-auth/` | Reminder only (Java too slow for auto-run) |
| onboarding | `micro-services/onboarding/` | `npx jest --changedSince=HEAD` |
| bff-ninja | `mobile/bff-ninja/` | `npx jest --changedSince=HEAD` |
| acme-gateway | `services/acme-gateway/` | `npx jest --changedSince=HEAD` |
| wallet-go | `wallet/wallet-go/` | `go test ./... -short` |
