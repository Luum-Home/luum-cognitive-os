...
- total_scripts: `531`
- by_mode: `{'observe-only': 229, 'os-maintainer-write': 264, 'profile-projection-write': 35, 'propose-only': 3}`
- by_status: `{'pass': 522, 'warn': 9}`
- dynamic_smokes: `4`
- dynamic_blocks: `0`
- block_count: `0`
...
| `project-shell-ci` | `pass` | 17 | `` |
| `cos-init-codex` | `pass` | 109 | `` |
