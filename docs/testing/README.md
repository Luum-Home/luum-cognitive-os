...
cd /Users/marialuzmontiel/projects/luum/luum-agent-os
...
HOOK = Path("/Users/marialuzmontiel/projects/luum/luum-agent-os/hooks/my-hook.sh")
...
```python
import sys
sys.path.insert(0, "/Users/marialuzmontiel/projects/luum/luum-agent-os")
