...
detect_service() {
  ...
  if [ -n "$work_dir" ]; then
    case "$work_dir" in
      *users-core*) echo "users-core"; return ;; *users-auth*) echo "users-auth"; return ;;
      *onboarding*) echo "onboarding"; return ;; *bff-ninja*) echo "bff-ninja"; return ;;
      *acme-gateway*) echo "acme-gateway"; return ;; *mobile/app*) echo "mobile-app"; return ;;
    esac
  fi
  echo "unknown"
}
