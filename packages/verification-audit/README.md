# @luum/verification-audit

Output verification and audit hooks — result truncation, observability, assumption tracking, architecture compliance

## Install

```bash
cos install @luum/verification-audit
```
