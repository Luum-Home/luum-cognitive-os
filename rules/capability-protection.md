...
7. **DO NOT** bulk-delete files from `.cognitive-os/hooks/`, `.cognitive-os/rules/`, `.cognitive-os/skills/`, `.cognitive-os/squads/`, or `.cognitive-os/agents/` without a prior capability snapshot.
