...
| `implementation/{service-name}/...` | Code decisions, patterns used, implementation notes | `implementation/users-core/pagination-pattern`, `implementation/bff/caching-strategy` |
...
- Service names match directory names: `users-core`, `bff-ninja`, `onboarding`, `payments-service`
