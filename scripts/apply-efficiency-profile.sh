...
echo "  Stop: session-learning.sh, session-cleanup.sh, git-context-capture.sh, session-changelog.sh, kpi-trigger.sh (async), engram-crystallize-on-session-end.sh (async)"
