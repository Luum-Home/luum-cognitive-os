...
echo "  PostToolUse *: context-watchdog.sh, subagent-budget-enforcer.sh, rate-limit-detector.sh, protected-config-write-detector.sh, codebase-itinerary-capture.sh (PROFILE=full adds tool-sequence-capture.sh + aci-observation-capture.sh)"
