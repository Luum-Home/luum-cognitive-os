"""Script-local PyYAML compatibility shim for projected Cognitive OS CLIs.
...
python3 in behavior tests and consumer projections. This file is intentionally
standalone because projected script bundles may not include the repository root
yaml.py shim.
"""
