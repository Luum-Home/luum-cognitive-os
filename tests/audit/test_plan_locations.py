...
ALLOWLIST_RELATIVE: list[str] = [
    ...
    "docs/02-Decisions/adrs/ADR-338-so-wide-impact-evaluation-plane.md",  # ADR title contains plane, not active plan inventory
    "docs/04-Concepts/architecture/so-wide-impact-evaluation-plane.md",  # architecture companion title contains plane, not active plan inventory
