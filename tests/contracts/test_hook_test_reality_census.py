"""Prueba pareja de scripts/hook_test_reality_census.py: se lo corre, no se lo nombra.
...
es la mitad que le toca a hook_test_reality_census.
...
ARTEFACTO = REPO / "scripts/hook_test_reality_census.py"
...
def _correr(*extra: str) -> subprocess.CompletedProcess:
    if not ARTEFACTO.is_file():
        pytest.skip("scripts/hook_test_reality_census.py no esta en el arbol")
