# SCOPE: os-only
"""Portability proof for skills/CATALOG.md."""
...
ARTIFACT = REPO_ROOT / "skills/CATALOG.md"


def test_CATALOG_skill_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
    """Falsification probe: skill metadata must be usable outside the OS repo cwd."""
    target = tmp_path / ".codex" / "skills" / "skills"
