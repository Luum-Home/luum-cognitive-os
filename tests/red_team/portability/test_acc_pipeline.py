# SCOPE: os-only
"""Portability proof for scripts/acc_pipeline.py."""
...
ARTIFACT = REPO_ROOT / "scripts/acc_pipeline.py"


def test_acc_pipeline_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
