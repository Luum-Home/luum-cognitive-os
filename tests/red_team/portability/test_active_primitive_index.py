# SCOPE: os-only
"""Portability proof for scripts/active_primitive_index.py."""
...
ARTIFACT = REPO_ROOT / "scripts/active_primitive_index.py"


def test_active_primitive_index_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
