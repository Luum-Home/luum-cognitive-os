# SCOPE: os-only
"""Portability proof for hooks/adaptive-bypass.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/adaptive-bypass.sh"


def test_adaptive_bypass_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
