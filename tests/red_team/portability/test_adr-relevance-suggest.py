# SCOPE: os-only
"""Portability proof for hooks/adr-relevance-suggest.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/adr-relevance-suggest.sh"


def test_adr_relevance_suggest_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
