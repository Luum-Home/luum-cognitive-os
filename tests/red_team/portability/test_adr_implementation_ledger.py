# SCOPE: os-only
"""Portability proof for scripts/adr_implementation_ledger.py."""
...
ARTIFACT = REPO_ROOT / "scripts/adr_implementation_ledger.py"


def test_adr_implementation_ledger_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
