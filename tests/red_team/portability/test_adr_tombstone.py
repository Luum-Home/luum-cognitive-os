# SCOPE: os-only
"""Portability proof for scripts/adr_tombstone.py."""
...
ARTIFACT = REPO_ROOT / "scripts/adr_tombstone.py"


def test_adr_tombstone_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
