# SCOPE: os-only
"""Portability proof for scripts/adr_verification_audit.py."""
...
ARTIFACT = REPO_ROOT / "scripts/adr_verification_audit.py"


def test_adr_verification_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
