# SCOPE: os-only
"""Portability proof for hooks/agent-bash-cwd-enforcer.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/agent-bash-cwd-enforcer.sh"


def test_agent_bash_cwd_enforcer_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
