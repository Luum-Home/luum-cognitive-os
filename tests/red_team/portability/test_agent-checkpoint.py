# SCOPE: os-only
"""Portability proof for hooks/agent-checkpoint.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/agent-checkpoint.sh"


def test_agent_checkpoint_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
