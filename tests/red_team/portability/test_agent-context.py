# SCOPE: os-only
"""Portability proof for hooks/_lib/agent-context.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/agent-context.sh"


def test_agent_context_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
