# SCOPE: os-only
"""Portability proof for hooks/agent-control-inbound-guard.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/agent-control-inbound-guard.sh"


def test_agent_control_inbound_guard_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
