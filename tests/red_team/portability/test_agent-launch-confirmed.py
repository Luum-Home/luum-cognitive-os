# SCOPE: os-only
"""Portability proof for hooks/agent-launch-confirmed.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/agent-launch-confirmed.sh"


def test_agent_launch_confirmed_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
