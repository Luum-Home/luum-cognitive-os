# SCOPE: os-only
"""Portability proof for hooks/agent-message-inbox-guard.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/agent-message-inbox-guard.sh"


def test_agent_message_inbox_guard_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
