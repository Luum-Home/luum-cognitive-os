# SCOPE: os-only
"""Portability proof for hooks/agent-prelaunch.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/agent-prelaunch.sh"


def test_agent_prelaunch_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
