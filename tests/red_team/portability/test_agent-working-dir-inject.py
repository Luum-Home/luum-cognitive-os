# SCOPE: os-only
"""Portability proof for hooks/agent-working-dir-inject.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/agent-working-dir-inject.sh"


def test_agent_working_dir_inject_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
