# SCOPE: os-only
"""Portability proof for scripts/ai_resource_economy_audit.py and wrapper."""
...
MODULE = REPO_ROOT / "scripts/ai_resource_economy_audit.py"
WRAPPER = REPO_ROOT / "scripts/ai-resource-economy-audit"


def test_ai_resource_economy_audit_safe_from_arbitrary_project_root(tmp_path: Path) -> None:
    env = os.environ.copy()
    env.update({
