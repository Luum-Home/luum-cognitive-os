# SCOPE: os-only
"""Portability proof for scripts/approval_ledger.py."""
...
ARTIFACT = REPO_ROOT / "scripts/approval_ledger.py"


def test_approval_ledger_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
