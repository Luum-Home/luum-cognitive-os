# SCOPE: os-only
"""Portability proof for hooks/_lib/artifact-status.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/artifact-status.sh"


def test_artifact_status_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
