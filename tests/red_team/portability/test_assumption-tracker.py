# SCOPE: os-only
"""Portability proof for hooks/assumption-tracker.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/assumption-tracker.sh"


def test_assumption_tracker_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
