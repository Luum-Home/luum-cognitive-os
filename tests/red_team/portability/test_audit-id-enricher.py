# SCOPE: os-only
"""Portability proof for hooks/audit-id-enricher.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/audit-id-enricher.sh"


def test_audit_id_enricher_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
