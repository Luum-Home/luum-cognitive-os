# SCOPE: os-only
"""Portability proof for hooks/auto-checkpoint.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/auto-checkpoint.sh"


def test_auto_checkpoint_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
