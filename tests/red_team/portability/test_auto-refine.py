# SCOPE: os-only
"""Portability proof for hooks/auto-refine.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/auto-refine.sh"


def test_auto_refine_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
