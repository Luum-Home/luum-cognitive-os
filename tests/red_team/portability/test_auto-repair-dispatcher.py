# SCOPE: os-only
"""Portability proof for hooks/auto-repair-dispatcher.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/auto-repair-dispatcher.sh"


def test_auto_repair_dispatcher_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
