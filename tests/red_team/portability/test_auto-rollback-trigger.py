# SCOPE: os-only
"""Portability proof for hooks/auto-rollback-trigger.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/auto-rollback-trigger.sh"


def test_auto_rollback_trigger_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
