# SCOPE: os-only
"""Portability proof for hooks/auto-verify.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/auto-verify.sh"


def test_auto_verify_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
