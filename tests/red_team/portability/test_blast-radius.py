# SCOPE: os-only
"""Portability proof for hooks/blast-radius.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/blast-radius.sh"


def test_blast_radius_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
