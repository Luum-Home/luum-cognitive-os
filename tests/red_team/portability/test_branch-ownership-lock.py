# SCOPE: os-only
"""Portability proof for hooks/branch-ownership-lock.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/branch-ownership-lock.sh"


def test_branch_ownership_lock_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
