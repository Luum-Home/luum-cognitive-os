# SCOPE: os-only
"""Portability proof for hooks/branch-ownership-release.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/branch-ownership-release.sh"


def test_branch_ownership_release_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
