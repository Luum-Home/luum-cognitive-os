# SCOPE: os-only
"""Portability proof for hooks/_lib/bypass-resolver.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/bypass-resolver.sh"


def test_bypass_resolver_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
