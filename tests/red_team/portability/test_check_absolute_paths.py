# SCOPE: os-only
"""Portability proof for scripts/check_absolute_paths.py."""
...
ARTIFACT = REPO_ROOT / "scripts/check_absolute_paths.py"


def test_check_absolute_paths_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
