# SCOPE: os-only
"""Portability proof for scripts/check_catalog_sync.py."""
...
ARTIFACT = REPO_ROOT / "scripts/check_catalog_sync.py"


def test_check_catalog_sync_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
