# SCOPE: os-only
"""Portability proof for scripts/check_hook_registration.py."""
...
ARTIFACT = REPO_ROOT / "scripts/check_hook_registration.py"


def test_check_hook_registration_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
