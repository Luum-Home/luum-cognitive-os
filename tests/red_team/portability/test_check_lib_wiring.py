# SCOPE: os-only
"""Portability proof for scripts/check_lib_wiring.py."""
...
ARTIFACT = REPO_ROOT / "scripts/check_lib_wiring.py"


def test_check_lib_wiring_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
