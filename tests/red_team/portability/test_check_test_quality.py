# SCOPE: os-only
"""Portability proof for scripts/check_test_quality.py."""
...
ARTIFACT = REPO_ROOT / "scripts/check_test_quality.py"


def test_check_quality_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
