# SCOPE: os-only
"""Portability proof for scripts/check_test_ratchet.py."""
...
ARTIFACT = REPO_ROOT / "scripts/check_test_ratchet.py"


def test_check_ratchet_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
