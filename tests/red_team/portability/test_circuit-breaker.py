# SCOPE: os-only
"""Portability proof for hooks/_lib/circuit-breaker.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/circuit-breaker.sh"


def test_circuit_breaker_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
