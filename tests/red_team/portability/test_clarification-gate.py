# SCOPE: os-only
"""Portability proof for hooks/clarification-gate.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/clarification-gate.sh"


def test_clarification_gate_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
