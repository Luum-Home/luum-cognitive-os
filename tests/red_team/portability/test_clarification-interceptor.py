# SCOPE: os-only
"""Portability proof for hooks/clarification-interceptor.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/clarification-interceptor.sh"


def test_clarification_interceptor_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
