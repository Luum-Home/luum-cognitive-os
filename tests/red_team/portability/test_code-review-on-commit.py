# SCOPE: os-only
"""Portability proof for hooks/code-review-on-commit.sh."""
...
ARTIFACT = REPO_ROOT / 'hooks/code-review-on-commit.sh'


def test_code_review_on_commit_artifact_exists() -> None:
