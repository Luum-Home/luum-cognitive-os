# SCOPE: os-only
"""Portability proof for hooks/_lib/common.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/common.sh"


def test_common_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
