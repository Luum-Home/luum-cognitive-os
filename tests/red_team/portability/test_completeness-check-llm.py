# SCOPE: os-only
"""Portability proof for hooks/completeness-check-llm.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/completeness-check-llm.sh"


def test_completeness_check_llm_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
