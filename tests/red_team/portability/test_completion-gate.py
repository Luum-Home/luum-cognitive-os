# SCOPE: os-only
"""Portability proof for hooks/completion-gate.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/completion-gate.sh"


def test_completion_gate_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
