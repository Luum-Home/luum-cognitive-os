# SCOPE: os-only
"""Portability proof for hooks/confidence-gate-llm.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/confidence-gate-llm.sh"


def test_confidence_gate_llm_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
