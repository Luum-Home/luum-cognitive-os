# SCOPE: os-only
"""Portability proof for hooks/confidentiality-enforcer.sh."""
...
ARTIFACT = REPO_ROOT / 'hooks/confidentiality-enforcer.sh'


def test_confidentiality_enforcer_artifact_exists() -> None:
