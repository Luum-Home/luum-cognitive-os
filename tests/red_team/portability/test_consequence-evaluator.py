# SCOPE: os-only
"""Portability proof for hooks/consequence-evaluator.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/consequence-evaluator.sh"


def test_consequence_evaluator_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
