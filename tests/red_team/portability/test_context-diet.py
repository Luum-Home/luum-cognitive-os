# SCOPE: os-only
"""Portability proof for hooks/context-diet.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/context-diet.sh"


def test_context_diet_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
