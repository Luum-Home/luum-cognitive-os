# SCOPE: os-only
"""Portability proof for hooks/context-watchdog.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/context-watchdog.sh"


def test_context_watchdog_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
