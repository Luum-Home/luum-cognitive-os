# SCOPE: os-only
"""Portability proof for hooks/_lib/context_budget_lib.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/context_budget_lib.sh"


def test_context_budget_lib_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
