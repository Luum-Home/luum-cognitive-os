# SCOPE: os-only
"""Portability proof for hooks/contextual-rule-loader.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/contextual-rule-loader.sh"


def test_contextual_rule_loader_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
