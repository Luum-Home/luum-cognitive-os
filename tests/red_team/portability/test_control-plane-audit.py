# SCOPE: os-only
"""Portability proof for hooks/control-plane-audit.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/control-plane-audit.sh"


def test_control_plane_audit_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
