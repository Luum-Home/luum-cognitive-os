# SCOPE: os-only
"""Portability proof for scripts/cos-action-receipt."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-action-receipt"


def test_cos_action_receipt_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
