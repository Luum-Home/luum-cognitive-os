# SCOPE: os-only
"""Portability proof for scripts/cos-adapter-compile."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-adapter-compile"


def test_cos_adapter_compile_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
