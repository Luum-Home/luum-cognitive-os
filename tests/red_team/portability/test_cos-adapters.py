# SCOPE: os-only
"""Portability proof for scripts/cos-adapters."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-adapters"


def test_cos_adapters_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
