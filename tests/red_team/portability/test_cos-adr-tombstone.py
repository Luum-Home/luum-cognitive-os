# SCOPE: os-only
"""Portability proof for scripts/cos-adr-tombstone."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-adr-tombstone"


def test_cos_adr_tombstone_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
