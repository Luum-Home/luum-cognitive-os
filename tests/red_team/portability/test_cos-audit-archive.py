# SCOPE: os-only
"""Portability proof for scripts/cos-audit-archive."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-audit-archive"


def test_cos_audit_archive_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
