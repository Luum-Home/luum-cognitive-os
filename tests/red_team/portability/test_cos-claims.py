# SCOPE: os-only
"""Portability proof for scripts/cos-claims.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-claims.sh"


def test_cos_claims_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
