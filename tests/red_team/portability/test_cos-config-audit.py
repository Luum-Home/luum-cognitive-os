# SCOPE: os-only
"""Portability proof for scripts/cos-config-audit.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-config-audit.sh"


def test_cos_config_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
