# SCOPE: os-only
"""Portability proof for scripts/cos-consumer-fleet-audit."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-consumer-fleet-audit"


def test_cos_consumer_fleet_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
