# SCOPE: os-only
"""Portability proof for scripts/cos-doctor-preserve.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-doctor-preserve.sh"


def test_cos_doctor_preserve_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
