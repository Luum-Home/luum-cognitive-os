# SCOPE: os-only
"""Portability proof for scripts/cos-document-ingest."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-document-ingest"


def test_cos_document_ingest_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
