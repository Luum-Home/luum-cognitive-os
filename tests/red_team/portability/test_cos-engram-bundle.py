# SCOPE: os-only
"""Portability proof for scripts/cos-engram-bundle."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-engram-bundle"


def test_cos_engram_bundle_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
...
def test_cos_engram_bundle_has_passing_scope_contract() -> None:
    result = subprocess.run(
        [
            sys.executable,
