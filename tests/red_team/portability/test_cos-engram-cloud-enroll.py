# SCOPE: os-only
"""Portability proof for scripts/cos-engram-cloud-enroll."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-engram-cloud-enroll"


def test_cos_engram_cloud_enroll_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
