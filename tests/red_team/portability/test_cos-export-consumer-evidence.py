# SCOPE: os-only
"""Portability proof for scripts/cos-export-consumer-evidence."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-export-consumer-evidence"


def test_cos_export_consumer_evidence_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
