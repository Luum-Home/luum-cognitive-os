# SCOPE: os-only
"""Portability proof for scripts/cos-federation-trigger-audit."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-federation-trigger-audit"


def test_cos_federation_trigger_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
