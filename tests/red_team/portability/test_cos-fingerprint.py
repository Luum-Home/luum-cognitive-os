# SCOPE: os-only
"""Portability proof for scripts/cos-fingerprint.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-fingerprint.sh"


def test_cos_fingerprint_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
