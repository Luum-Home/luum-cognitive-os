# SCOPE: os-only
"""Portability proof for scripts/cos-git-sync.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-git-sync.sh"


def test_cos_git_sync_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
