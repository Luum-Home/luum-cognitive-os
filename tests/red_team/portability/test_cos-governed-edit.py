# SCOPE: os-only
"""Portability proof for scripts/cos-governed-edit.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-governed-edit.sh"


def test_cos_governed_edit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
