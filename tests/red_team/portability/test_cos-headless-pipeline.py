# SCOPE: os-only
"""Portability proof for scripts/cos-headless-pipeline."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-headless-pipeline"


def test_cos_headless_pipeline_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
