# SCOPE: os-only
"""Portability proof for scripts/cos-headless-runtime-contract."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-headless-runtime-contract"


def test_cos_headless_runtime_contract_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
