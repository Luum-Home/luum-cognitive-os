# SCOPE: os-only
"""Portability proof for scripts/cos-headless-safe-mode."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-headless-safe-mode"


def test_cos_headless_safe_mode_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
