# SCOPE: os-only
"""Portability proof for scripts/cos-homebrew-local-canary."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-homebrew-local-canary"


def test_cos_homebrew_local_canary_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
