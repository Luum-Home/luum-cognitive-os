# SCOPE: os-only
"""Portability proof for scripts/cos-import-consumer-evidence."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-import-consumer-evidence"


def test_cos_import_consumer_evidence_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
