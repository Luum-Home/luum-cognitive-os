# SCOPE: os-only
"""Portability proof for scripts/cos-import-consumer-improvement-proposals."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-import-consumer-improvement-proposals"


def test_cos_import_consumer_improvement_proposals_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
