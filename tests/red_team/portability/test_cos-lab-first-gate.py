# SCOPE: os-only
"""Portability proof for scripts/cos-lab-first-gate."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-lab-first-gate"


def test_cos_lab_first_gate_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
