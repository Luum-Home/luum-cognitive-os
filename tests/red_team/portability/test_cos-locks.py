# SCOPE: os-only
"""Portability proof for scripts/cos-locks.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-locks.sh"


def test_cos_locks_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
