# SCOPE: os-only
"""Portability proof for scripts/cos-mcp-registration-plan."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-mcp-registration-plan"


def test_cos_mcp_registration_plan_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
