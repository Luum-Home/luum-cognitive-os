# SCOPE: os-only
"""Portability proof for scripts/cos-merge-queue.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-merge-queue.sh"


def test_cos_merge_queue_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
