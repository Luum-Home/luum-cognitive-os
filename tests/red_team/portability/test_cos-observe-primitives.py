# SCOPE: os-only
"""Portability proof for scripts/cos-observe-primitives."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-observe-primitives"


def test_cos_observe_primitives_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
