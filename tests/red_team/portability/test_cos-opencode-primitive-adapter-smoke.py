# SCOPE: os-only
"""Portability proof for scripts/cos-opencode-primitive-adapter-smoke."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-opencode-primitive-adapter-smoke"


def test_cos_opencode_primitive_adapter_smoke_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
