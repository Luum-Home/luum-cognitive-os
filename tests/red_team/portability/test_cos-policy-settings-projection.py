# SCOPE: os-only
"""Portability proof for scripts/cos-policy-settings-projection."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-policy-settings-projection"


def test_cos_policy_settings_projection_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
