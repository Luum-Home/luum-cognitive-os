# SCOPE: os-only
"""Portability proof for scripts/cos-portability-proof-scaffold."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-portability-proof-scaffold"


def test_cos_portability_proof_scaffold_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
