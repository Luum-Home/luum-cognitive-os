# SCOPE: os-only
"""Portability proof for scripts/cos-portable-ai-consumer-impact."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-portable-ai-consumer-impact"


def test_cos_portable_ai_consumer_impact_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
