# SCOPE: os-only
"""Portability proof for scripts/cos-portable-ai-consumer-package-smoke."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-portable-ai-consumer-package-smoke"


def test_cos_portable_ai_consumer_package_smoke_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
