# SCOPE: os-only
"""Portability proof for scripts/cos-portable-ai-consumer-smoke."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-portable-ai-consumer-smoke"


def test_cos_portable_ai_consumer_smoke_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
