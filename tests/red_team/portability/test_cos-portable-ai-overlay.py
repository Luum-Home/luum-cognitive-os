# SCOPE: os-only
"""Portability proof for scripts/cos-portable-ai-overlay."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-portable-ai-overlay"


def test_cos_portable_ai_overlay_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
