# SCOPE: os-only
"""Portability proof for scripts/cos-primitive-projection-fidelity."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-primitive-projection-fidelity"


def test_cos_primitive_projection_fidelity_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
