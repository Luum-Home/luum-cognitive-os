# SCOPE: os-only
"""Portability proof for scripts/cos-primitive-service-headless-smoke."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-primitive-service-headless-smoke"


def test_cos_primitive_service_headless_smoke_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
