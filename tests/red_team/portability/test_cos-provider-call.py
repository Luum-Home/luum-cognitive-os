# SCOPE: os-only
"""Portability proof for scripts/cos-provider-call."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-provider-call"


def test_cos_provider_call_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
