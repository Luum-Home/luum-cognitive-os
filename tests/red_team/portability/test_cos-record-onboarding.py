# SCOPE: os-only
"""Portability proof for scripts/cos-record-onboarding.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-record-onboarding.sh"


def test_cos_record_onboarding_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
