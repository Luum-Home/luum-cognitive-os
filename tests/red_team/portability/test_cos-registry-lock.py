# SCOPE: os-only
"""Portability proof for scripts/cos-registry-lock."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-registry-lock"


def test_cos_registry_lock_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
