# SCOPE: os-only
"""Portability proof for scripts/cos-release-check.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-release-check.sh"


def test_cos_release_check_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
