# SCOPE: os-only
"""Portability proof for scripts/cos-repair."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-repair"


def test_cos_repair_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
