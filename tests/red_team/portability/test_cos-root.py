# SCOPE: os-only
"""Portability proof for scripts/cos-root."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-root"


def test_cos_root_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
