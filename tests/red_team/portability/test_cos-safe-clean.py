# SCOPE: os-only
"""Portability proof for scripts/cos-safe-clean."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-safe-clean"


def test_cos_safe_clean_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
