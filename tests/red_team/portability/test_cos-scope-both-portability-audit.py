# SCOPE: os-only
"""Portability proof for scripts/cos-scope-both-portability-audit."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-scope-both-portability-audit"


def test_cos_scope_both_portability_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
