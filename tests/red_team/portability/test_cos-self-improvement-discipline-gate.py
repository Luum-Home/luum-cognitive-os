# SCOPE: os-only
"""Portability proof for scripts/cos-self-improvement-discipline-gate."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-self-improvement-discipline-gate"


def test_cos_self_improvement_discipline_gate_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
