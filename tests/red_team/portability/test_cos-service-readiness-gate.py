# SCOPE: os-only
"""Portability proof for scripts/cos-service-readiness-gate."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-service-readiness-gate"


def test_cos_service_readiness_gate_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
