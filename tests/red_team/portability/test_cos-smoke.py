# SCOPE: os-only
"""Portability proof for scripts/cos-smoke.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-smoke.sh"


def test_cos_smoke_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
