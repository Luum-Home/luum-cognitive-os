# SCOPE: os-only
"""Portability proof for scripts/cos-team."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-team"


def test_cos_team_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
