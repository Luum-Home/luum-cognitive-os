# SCOPE: os-only
"""Portability proof for scripts/cos-tui."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-tui"


def test_cos_tui_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
