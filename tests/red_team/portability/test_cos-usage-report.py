# SCOPE: os-only
"""Portability proof for scripts/cos-usage-report.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-usage-report.sh"


def test_cos_usage_report_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
