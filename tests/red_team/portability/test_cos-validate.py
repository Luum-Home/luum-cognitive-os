# SCOPE: os-only
"""Portability proof for scripts/cos-validate."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-validate"


def test_cos_validate_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
