# SCOPE: os-only
"""Portability proof for scripts/cos-validation-capsule.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-validation-capsule.sh"


def test_cos_validation_capsule_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
