# SCOPE: os-only
"""Portability proof for scripts/cos-wiki-ingest."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-wiki-ingest"


def test_cos_wiki_ingest_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
