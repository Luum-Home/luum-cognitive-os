# SCOPE: os-only
"""Portability proof for scripts/cos_adoption_profile.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_adoption_profile.py"


def test_cos_adoption_profile_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
