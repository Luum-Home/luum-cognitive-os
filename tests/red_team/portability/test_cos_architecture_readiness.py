# SCOPE: os-only
"""Portability proof for scripts/cos_architecture_readiness.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_architecture_readiness.py"


def test_cos_architecture_readiness_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
