# SCOPE: os-only
"""Portability proof for scripts/cos_artifact_workflow.py."""
...
ARTIFACT = REPO_ROOT / 'scripts/cos_artifact_workflow.py'


def test_cos_artifact_workflow_artifact_exists() -> None:
