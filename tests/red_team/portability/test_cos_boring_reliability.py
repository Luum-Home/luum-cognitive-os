# SCOPE: os-only
"""Portability proof for scripts/cos_boring_reliability.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_boring_reliability.py"


def test_cos_boring_reliability_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
