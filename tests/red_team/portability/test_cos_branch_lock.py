# SCOPE: os-only
"""Portability proof for scripts/cos_branch_lock.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_branch_lock.py"


def test_cos_branch_lock_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
