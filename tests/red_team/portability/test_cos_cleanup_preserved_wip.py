# SCOPE: os-only
"""Portability proof for scripts/cos_cleanup_preserved_wip.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_cleanup_preserved_wip.py"


def test_cos_cleanup_preserved_wip_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
