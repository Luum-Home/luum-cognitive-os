# SCOPE: os-only
"""Portability proof for scripts/cos_consumer_improvement_proposals.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_consumer_improvement_proposals.py"


def test_cos_consumer_improvement_proposals_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
