# SCOPE: os-only
"""Portability proof for scripts/cos_context_budget_report.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_context_budget_report.py"


def test_cos_context_budget_report_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
