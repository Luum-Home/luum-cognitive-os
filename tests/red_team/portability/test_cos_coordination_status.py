# SCOPE: os-only
"""Portability proof for scripts/cos_coordination_status.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_coordination_status.py"


def test_cos_coordination_status_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
