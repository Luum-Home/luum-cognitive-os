# SCOPE: os-only
"""Portability proof for scripts/cos_cross_instance_learning.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_cross_instance_learning.py"


def test_cos_cross_instance_learning_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
