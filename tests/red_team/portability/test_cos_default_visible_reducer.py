# SCOPE: os-only
"""Portability proof for scripts/cos_default_visible_reducer.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_default_visible_reducer.py"


def test_cos_default_visible_reducer_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
