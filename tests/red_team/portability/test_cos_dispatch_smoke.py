# SCOPE: os-only
"""Portability proof for scripts/cos_dispatch_smoke.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_dispatch_smoke.py"


def test_cos_dispatch_smoke_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
