# SCOPE: os-only
"""Portability proof for scripts/cos_doctrine_proposer.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_doctrine_proposer.py"


def test_cos_doctrine_proposer_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
