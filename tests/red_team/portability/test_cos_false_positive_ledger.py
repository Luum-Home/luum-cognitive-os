# SCOPE: os-only
"""Portability proof for scripts/cos_false_positive_ledger.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_false_positive_ledger.py"


def test_cos_false_positive_ledger_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
