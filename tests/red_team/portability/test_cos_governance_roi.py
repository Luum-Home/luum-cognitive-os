# SCOPE: os-only
"""Portability proof for scripts/cos_governance_roi.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_governance_roi.py"


def test_cos_governance_roi_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
