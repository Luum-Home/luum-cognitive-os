# SCOPE: os-only
"""Portability proof for scripts/cos_governed_self_improvement.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_governed_self_improvement.py"


def test_cos_governed_self_improvement_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
