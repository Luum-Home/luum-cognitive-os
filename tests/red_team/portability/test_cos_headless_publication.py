# SCOPE: os-only
"""Portability proof for scripts/cos_headless_publication.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_headless_publication.py"


def test_cos_headless_publication_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
