# SCOPE: os-only
"""Portability proof for scripts/cos_key_learnings_capture.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_key_learnings_capture.py"


def test_cos_key_learnings_capture_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
