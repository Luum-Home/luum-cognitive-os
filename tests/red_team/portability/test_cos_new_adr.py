# SCOPE: os-only
"""Portability proof for scripts/cos_new_adr.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_new_adr.py"


def test_cos_new_adr_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
