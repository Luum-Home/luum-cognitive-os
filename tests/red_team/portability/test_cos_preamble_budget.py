# SCOPE: os-only
"""Portability proof for scripts/cos_preamble_budget.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_preamble_budget.py"


def test_cos_preamble_budget_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
