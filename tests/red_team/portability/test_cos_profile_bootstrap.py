# SCOPE: os-only
"""Portability proof for scripts/cos_profile_bootstrap.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_profile_bootstrap.py"


def test_cos_profile_bootstrap_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
