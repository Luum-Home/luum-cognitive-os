# SCOPE: os-only
"""Portability proof for scripts/cos_recovery_drill.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_recovery_drill.py"


def test_cos_recovery_drill_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
