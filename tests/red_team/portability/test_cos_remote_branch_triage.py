# SCOPE: os-only
"""Portability proof for scripts/cos_remote_branch_triage.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_remote_branch_triage.py"


def test_cos_remote_branch_triage_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
