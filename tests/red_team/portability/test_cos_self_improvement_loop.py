# SCOPE: os-only
"""Portability proof for scripts/cos_self_improvement_loop.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_self_improvement_loop.py"


def test_cos_self_improvement_loop_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
