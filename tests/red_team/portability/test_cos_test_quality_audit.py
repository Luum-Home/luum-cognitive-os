# SCOPE: os-only
"""Portability proof for scripts/cos_test_quality_audit.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_test_quality_audit.py"


def test_cos_quality_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
