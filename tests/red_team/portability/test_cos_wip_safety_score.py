# SCOPE: os-only
"""Portability proof for scripts/cos_wip_safety_score.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_wip_safety_score.py"


def test_cos_wip_safety_score_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
