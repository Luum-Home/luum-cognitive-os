# SCOPE: os-only
"""Portability proof for scripts/cos_worktree_sweeper.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cos_worktree_sweeper.py"


def test_cos_worktree_sweeper_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
