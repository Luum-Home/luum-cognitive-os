# SCOPE: os-only
"""Portability proof for hooks/cosd-auth-guard.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/cosd-auth-guard.sh"


def test_cosd_auth_guard_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
