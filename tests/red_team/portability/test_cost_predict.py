# SCOPE: os-only
"""Portability proof for scripts/cost_predict.py."""
...
ARTIFACT = REPO_ROOT / "scripts/cost_predict.py"


def test_cost_predict_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
