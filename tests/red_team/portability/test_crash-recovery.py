# SCOPE: os-only
"""Portability proof for hooks/crash-recovery.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/crash-recovery.sh"


def test_crash_recovery_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
