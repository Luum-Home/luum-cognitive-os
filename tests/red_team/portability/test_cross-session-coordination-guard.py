# SCOPE: os-only
"""Portability proof for hooks/cross-session-coordination-guard.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/cross-session-coordination-guard.sh"


def test_cross_session_coordination_guard_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
