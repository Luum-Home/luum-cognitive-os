# SCOPE: os-only
"""Portability proof for hooks/dangerous-env-flag-detector.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/dangerous-env-flag-detector.sh"


def test_dangerous_env_flag_detector_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
