# SCOPE: os-only
"""Portability proof for scripts/decision_triage.py."""
...
ARTIFACT = REPO_ROOT / "scripts/decision_triage.py"


def test_decision_triage_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
