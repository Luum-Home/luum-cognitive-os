# SCOPE: os-only
"""Portability proof for scripts/derived_artifact_gate.py."""
...
ARTIFACT = REPO_ROOT / "scripts/derived_artifact_gate.py"


def test_derived_artifact_gate_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
