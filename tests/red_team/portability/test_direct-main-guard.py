# SCOPE: os-only
"""Portability proof for hooks/direct-main-guard.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/direct-main-guard.sh"


def test_direct_main_guard_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
