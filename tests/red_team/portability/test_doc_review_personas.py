# SCOPE: os-only
"""Portability proof for scripts/doc_review_personas.py."""
...
ARTIFACT = REPO_ROOT / "scripts/doc_review_personas.py"


def test_doc_review_personas_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
