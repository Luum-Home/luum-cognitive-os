# SCOPE: os-only
"""Portability proof for hooks/document-ingest-guard.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/document-ingest-guard.sh"


def test_document_ingest_guard_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
