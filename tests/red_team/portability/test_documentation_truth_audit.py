# SCOPE: os-only
"""Portability proof for scripts/documentation_truth_audit.py."""
...
ARTIFACT = REPO_ROOT / "scripts/documentation_truth_audit.py"


def test_documentation_truth_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
