# SCOPE: os-only
"""Portability proof for hooks/dod-gate.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/dod-gate.sh"


def test_dod_gate_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
