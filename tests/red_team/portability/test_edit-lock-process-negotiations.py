# SCOPE: os-only
"""Portability proof for hooks/edit-lock-process-negotiations.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/edit-lock-process-negotiations.sh"


def test_edit_lock_process_negotiations_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
