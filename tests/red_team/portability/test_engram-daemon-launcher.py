# SCOPE: os-only
"""Portability proof for hooks/engram-daemon-launcher.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/engram-daemon-launcher.sh"


def test_engram_daemon_launcher_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
