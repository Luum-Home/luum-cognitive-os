# SCOPE: os-only
"""Portability proof for hooks/engram-obsidian-export-on-stop.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/engram-obsidian-export-on-stop.sh"


def test_engram_obsidian_export_on_stop_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
