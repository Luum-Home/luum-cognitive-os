# SCOPE: os-only
"""Portability proof for hooks/engram-reinforce-on-access.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/engram-reinforce-on-access.sh"


def test_engram_reinforce_on_access_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
