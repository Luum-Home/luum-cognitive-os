...
Falsification probe: if engram_lifecycle imports cos_lib.memory_governance but the
...
def test_imports_in_clean_env(tmp_path):
    code = (
        ...
        "from cos_lib import engram_lifecycle\n"
...
def test_governance_module_referenceable():
    code = (
        "import sys; sys.path.insert(0, %r);\n"
        "from cos_lib import engram_lifecycle\n"
        "import cos_lib.memory_governance as mg\n"
