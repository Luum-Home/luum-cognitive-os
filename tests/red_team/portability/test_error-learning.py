# SCOPE: os-only
"""Portability proof for hooks/error-learning.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/error-learning.sh"


def test_error_learning_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
