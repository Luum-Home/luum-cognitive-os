# SCOPE: os-only
"""Portability proof for hooks/_lib/execute-repair.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/execute-repair.sh"


def test_execute_repair_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
