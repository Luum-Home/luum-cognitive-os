# SCOPE: os-only
"""Portability proof for scripts/export-engram-to-obsidian.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/export-engram-to-obsidian.sh"


def test_export_engram_to_obsidian_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
