# SCOPE: os-only
"""Portability proof for hooks/_lib/file_checker.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/file_checker.sh"


def test_file_checker_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
