# SCOPE: os-only
"""Portability proof for scripts/generate_compact_catalog.py."""
...
ARTIFACT = REPO_ROOT / "scripts/generate_compact_catalog.py"


def test_generate_compact_catalog_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
