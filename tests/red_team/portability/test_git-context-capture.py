# SCOPE: os-only
"""Portability proof for hooks/git-context-capture.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/git-context-capture.sh"


def test_git_context_capture_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
