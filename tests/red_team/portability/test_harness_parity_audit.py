# SCOPE: os-only
"""Portability proof for scripts/harness_parity_audit.py."""
...
ARTIFACT = REPO_ROOT / "scripts/harness_parity_audit.py"


def test_harness_parity_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
