# SCOPE: os-only
"""Portability proof for hooks/_lib/hook-pipe.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/hook-pipe.sh"


def test_hook_pipe_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
