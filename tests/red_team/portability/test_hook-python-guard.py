# SCOPE: os-only
"""Portability proof for hooks/_lib/hook-python-guard.sh."""
...
ARTIFACT = REPO_ROOT / 'hooks/_lib/hook-python-guard.sh'


def test_hook_python_guard_artifact_exists() -> None:
