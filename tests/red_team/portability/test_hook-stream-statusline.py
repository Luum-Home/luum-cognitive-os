# SCOPE: os-only
"""Portability proof for scripts/hook-stream-statusline.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/hook-stream-statusline.sh"


def test_hook_stream_statusline_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
