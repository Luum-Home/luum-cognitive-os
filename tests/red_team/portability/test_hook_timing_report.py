# SCOPE: os-only
"""Portability proof for scripts/hook_timing_report.py."""
...
ARTIFACT = REPO_ROOT / "scripts/hook_timing_report.py"


def test_hook_timing_report_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
