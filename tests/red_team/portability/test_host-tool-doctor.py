# SCOPE: os-only
"""Portability proof for hooks/host-tool-doctor.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/host-tool-doctor.sh"


def test_host_tool_doctor_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
