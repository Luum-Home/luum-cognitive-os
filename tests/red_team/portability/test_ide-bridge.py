# SCOPE: os-only
"""Portability proof for scripts/ide-bridge.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/ide-bridge.sh"


def test_ide_bridge_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
