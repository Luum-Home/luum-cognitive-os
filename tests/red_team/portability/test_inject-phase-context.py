# SCOPE: os-only
"""Portability proof for hooks/inject-phase-context.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/inject-phase-context.sh"


def test_inject_phase_context_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
