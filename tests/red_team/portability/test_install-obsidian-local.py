# SCOPE: os-only
"""Portability proof for scripts/install-obsidian-local.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/install-obsidian-local.sh"


def test_install_obsidian_local_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
