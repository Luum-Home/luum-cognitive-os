# SCOPE: os-only
"""Portability proof for scripts/invariant_check_helper.py."""
...
ARTIFACT = REPO_ROOT / "scripts/invariant_check_helper.py"


def test_invariant_check_helper_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
