# SCOPE: os-only
"""Portability proof for hooks/_lib/killswitch_check.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/killswitch_check.sh"


def test_killswitch_check_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
