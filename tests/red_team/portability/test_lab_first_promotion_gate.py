# SCOPE: os-only
"""Portability proof for scripts/lab_first_promotion_gate.py."""
...
ARTIFACT = REPO_ROOT / "scripts/lab_first_promotion_gate.py"


def test_lab_first_promotion_gate_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
