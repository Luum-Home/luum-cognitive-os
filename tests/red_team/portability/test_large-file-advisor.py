# SCOPE: os-only
"""Portability proof for hooks/large-file-advisor.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/large-file-advisor.sh"


def test_large_file_advisor_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
