# SCOPE: os-only
"""Portability proof for hooks/memory-prefetch.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/memory-prefetch.sh"


def test_memory_prefetch_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
