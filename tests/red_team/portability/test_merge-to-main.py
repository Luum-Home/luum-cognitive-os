# SCOPE: os-only
"""Portability proof for scripts/merge-to-main.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/merge-to-main.sh"


def test_merge_to_main_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
