# SCOPE: os-only
"""Portability proof for hooks/_lib/normalize-stdin.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/normalize-stdin.sh"


def test_normalize_stdin_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
