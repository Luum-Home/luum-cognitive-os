# SCOPE: os-only
"""Portability proof for hooks/notify.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/notify.sh"


def test_notify_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
