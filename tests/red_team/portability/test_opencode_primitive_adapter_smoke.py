# SCOPE: os-only
"""Portability proof for scripts/opencode_primitive_adapter_smoke.py."""
...
ARTIFACT = REPO_ROOT / "scripts/opencode_primitive_adapter_smoke.py"


def test_opencode_primitive_adapter_smoke_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
