# SCOPE: os-only
"""Portability proof for hooks/orchestrator-decision-trace.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/orchestrator-decision-trace.sh"


def test_orchestrator_decision_trace_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
