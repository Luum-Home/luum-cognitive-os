# SCOPE: os-only
"""Portability proof for hooks/orchestrator-mode-detect.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/orchestrator-mode-detect.sh"


def test_orchestrator_mode_detect_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
