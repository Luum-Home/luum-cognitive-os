# SCOPE: os-only
"""Portability proof for scripts/orchestrator.py."""
...
ARTIFACT = REPO_ROOT / "scripts/orchestrator.py"


def test_orchestrator_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
