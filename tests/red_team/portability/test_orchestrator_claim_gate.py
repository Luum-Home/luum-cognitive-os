# SCOPE: os-only
"""Portability proof for scripts/orchestrator_claim_gate.py."""
...
ARTIFACT = REPO_ROOT / "scripts/orchestrator_claim_gate.py"


def test_orchestrator_claim_gate_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
