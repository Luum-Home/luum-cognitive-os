# SCOPE: os-only
"""Portability proof for scripts/orphan_commit_scan.py."""
...
ARTIFACT = REPO_ROOT / "scripts/orphan_commit_scan.py"


def test_orphan_commit_scan_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
