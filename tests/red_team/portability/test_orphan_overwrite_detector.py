# SCOPE: os-only
"""Portability proof for scripts/orphan_overwrite_detector.py."""
...
ARTIFACT = REPO_ROOT / "scripts/orphan_overwrite_detector.py"


def test_orphan_overwrite_detector_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
