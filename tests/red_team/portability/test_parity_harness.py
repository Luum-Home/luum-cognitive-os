# SCOPE: os-only
"""Portability proof for scripts/parity_harness.py."""
...
ARTIFACT = REPO_ROOT / "scripts/parity_harness.py"


def test_parity_harness_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
