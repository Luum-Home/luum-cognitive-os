# SCOPE: os-only
"""Portability proof for hooks/_lib/portable.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/portable.sh"


def test_portable_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
