# SCOPE: os-only
"""Portability proof for scripts/portable_ai_consumer_impact.py."""
...
ARTIFACT = REPO_ROOT / "scripts/portable_ai_consumer_impact.py"


def test_portable_ai_consumer_impact_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
