# SCOPE: os-only
"""Portability proof for scripts/portable_ai_consumer_package.py."""
...
ARTIFACT = REPO_ROOT / "scripts/portable_ai_consumer_package.py"


def test_portable_ai_consumer_package_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
