# SCOPE: os-only
"""Portability proof for scripts/portable_ai_consumer_smoke.py."""
...
ARTIFACT = REPO_ROOT / "scripts/portable_ai_consumer_smoke.py"


def test_portable_ai_consumer_smoke_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
