# SCOPE: os-only
"""Portability proof for hooks/pre-agent-snapshot.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/pre-agent-snapshot.sh"


def test_pre_agent_snapshot_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
