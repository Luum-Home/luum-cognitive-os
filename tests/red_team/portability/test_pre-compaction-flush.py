# SCOPE: os-only
"""Portability proof for hooks/pre-compaction-flush.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/pre-compaction-flush.sh"


def test_pre_compaction_flush_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
