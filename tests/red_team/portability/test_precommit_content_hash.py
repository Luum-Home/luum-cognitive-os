# SCOPE: os-only
"""Portability proof for scripts/precommit_content_hash.py."""
...
ARTIFACT = REPO_ROOT / "scripts/precommit_content_hash.py"


def test_precommit_content_hash_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
