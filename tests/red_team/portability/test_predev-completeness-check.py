# SCOPE: os-only
"""Portability proof for hooks/predev-completeness-check.sh."""
...
ARTIFACT = REPO_ROOT / 'hooks/predev-completeness-check.sh'


def test_predev_completeness_check_artifact_exists() -> None:
