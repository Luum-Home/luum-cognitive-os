# SCOPE: os-only
"""Portability proof for hooks/_lib/primitive-intervention.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/primitive-intervention.sh"


def test_primitive_intervention_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
