# SCOPE: os-only
"""Portability proof for scripts/primitive_fitness_ledger.py."""
...
ARTIFACT = REPO_ROOT / "scripts/primitive_fitness_ledger.py"


def test_primitive_fitness_ledger_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
