# SCOPE: os-only
"""Portability proof for scripts/primitive_harness_coverage.py."""
...
ARTIFACT = REPO_ROOT / "scripts/primitive_harness_coverage.py"


def test_primitive_harness_coverage_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
