# SCOPE: os-only
"""Portability proof for scripts/primitive_projection_fidelity.py."""
...
ARTIFACT = REPO_ROOT / "scripts/primitive_projection_fidelity.py"


def test_primitive_projection_fidelity_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
