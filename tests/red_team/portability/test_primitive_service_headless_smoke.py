# SCOPE: os-only
"""Portability proof for scripts/primitive_service_headless_smoke.py."""
...
ARTIFACT = REPO_ROOT / "scripts/primitive_service_headless_smoke.py"


def test_primitive_service_headless_smoke_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
