# SCOPE: os-only
"""Portability proof for hooks/profile-drift-autoapply.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/profile-drift-autoapply.sh"


def test_profile_drift_autoapply_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
