# SCOPE: os-only
"""Portability proof for hooks/project-docs-convention.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/project-docs-convention.sh"


def test_project_docs_convention_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
