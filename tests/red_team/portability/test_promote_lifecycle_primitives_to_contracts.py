# SCOPE: os-only
"""Portability proof for scripts/promote_lifecycle_primitives_to_contracts.py."""
...
ARTIFACT = REPO_ROOT / "scripts/promote_lifecycle_primitives_to_contracts.py"


def test_promote_lifecycle_primitives_to_contracts_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
