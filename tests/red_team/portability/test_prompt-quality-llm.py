# SCOPE: os-only
"""Portability proof for hooks/prompt-quality-llm.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/prompt-quality-llm.sh"


def test_prompt_quality_llm_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
