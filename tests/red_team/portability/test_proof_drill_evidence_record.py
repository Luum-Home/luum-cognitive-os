# SCOPE: os-only
"""Portability proof for scripts/proof_drill_evidence_record.py."""
...
ARTIFACT = REPO_ROOT / "scripts/proof_drill_evidence_record.py"


def test_proof_drill_evidence_record_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
