# SCOPE: os-only
"""Portability proof for scripts/pytest-with-summary.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/pytest-with-summary.sh"


def test_pytest_with_summary_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
