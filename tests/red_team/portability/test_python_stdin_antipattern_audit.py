# SCOPE: os-only
"""Portability proof for scripts/python_stdin_antipattern_audit.py."""
...
ARTIFACT = REPO_ROOT / "scripts/python_stdin_antipattern_audit.py"


def test_python_stdin_antipattern_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
