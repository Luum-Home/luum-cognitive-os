# SCOPE: os-only
"""Portability proof for hooks/query-tailored-context-inject.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/query-tailored-context-inject.sh"


def test_query_tailored_context_inject_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
