# SCOPE: os-only
"""Portability proof for hooks/rate-limit-protection.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/rate-limit-protection.sh"


def test_rate_limit_protection_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
