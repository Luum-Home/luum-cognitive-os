# SCOPE: os-only
"""Portability proof for scripts/redteam_aggregate.py."""
...
ARTIFACT = REPO_ROOT / "scripts/redteam_aggregate.py"


def test_redteam_aggregate_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
