# SCOPE: os-only
"""Portability proof for hooks/_lib/register-bg.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/register-bg.sh"


def test_register_bg_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
