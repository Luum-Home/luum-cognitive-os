# SCOPE: os-only
"""Portability proof for hooks/research-quality-validator.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/research-quality-validator.sh"


def test_research_quality_validator_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
