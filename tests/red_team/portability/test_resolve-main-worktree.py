# SCOPE: os-only
"""Portability proof for hooks/_lib/resolve-main-worktree.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/resolve-main-worktree.sh"


def test_resolve_main_worktree_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
