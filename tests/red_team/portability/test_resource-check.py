# SCOPE: os-only
"""Portability proof for hooks/resource-check.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/resource-check.sh"


def test_resource_check_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
