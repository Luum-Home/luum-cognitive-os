# SCOPE: os-only
"""Portability proof for scripts/resource_lease.py."""
...
ARTIFACT = REPO_ROOT / "scripts/resource_lease.py"


def test_resource_lease_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
