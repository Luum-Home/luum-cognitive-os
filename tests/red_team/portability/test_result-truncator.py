# SCOPE: os-only
"""Portability proof for hooks/result-truncator.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/result-truncator.sh"


def test_result_truncator_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
