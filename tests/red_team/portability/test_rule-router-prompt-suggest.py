# SCOPE: os-only
"""Portability proof for hooks/rule-router-prompt-suggest.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/rule-router-prompt-suggest.sh"


def test_rule_router_prompt_suggest_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
