# SCOPE: os-only
"""Portability proof for scripts/rules_export.py."""
...
ARTIFACT = REPO_ROOT / "scripts/rules_export.py"


def test_rules_export_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
