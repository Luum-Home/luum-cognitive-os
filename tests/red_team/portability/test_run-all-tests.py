# SCOPE: os-only
"""Portability proof for scripts/run-all-tests.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/run-all-tests.sh"


def test_run_all_tests_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
