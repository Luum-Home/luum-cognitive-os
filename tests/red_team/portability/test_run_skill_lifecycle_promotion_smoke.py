# SCOPE: os-only
"""Portability proof for scripts/run_skill_lifecycle_promotion_smoke.py."""
...
ARTIFACT = REPO_ROOT / "scripts/run_skill_lifecycle_promotion_smoke.py"


def test_run_skill_lifecycle_promotion_smoke_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
