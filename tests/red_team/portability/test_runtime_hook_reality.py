# SCOPE: os-only
"""Portability proof for scripts/runtime_hook_reality.py."""
...
ARTIFACT = REPO_ROOT / "scripts/runtime_hook_reality.py"


def test_runtime_hook_reality_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
