# SCOPE: os-only
"""Portability proof for hooks/_lib/safe-jsonl.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/safe-jsonl.sh"


def test_safe_jsonl_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
