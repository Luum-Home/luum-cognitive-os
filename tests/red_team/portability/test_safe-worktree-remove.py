# SCOPE: os-only
"""Portability proof for hooks/_lib/safe-worktree-remove.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/safe-worktree-remove.sh"


def test_safe_worktree_remove_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
