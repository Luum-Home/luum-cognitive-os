# SCOPE: os-only
"""Portability proof for hooks/scope-creep-detector.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/scope-creep-detector.sh"


def test_scope_creep_detector_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
