# SCOPE: os-only
"""Portability proof for hooks/scope-proportionality.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/scope-proportionality.sh"


def test_scope_proportionality_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
