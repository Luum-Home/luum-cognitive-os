# SCOPE: os-only
"""Portability proof for hooks/secret-detector.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/secret-detector.sh"


def test_secret_detector_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
