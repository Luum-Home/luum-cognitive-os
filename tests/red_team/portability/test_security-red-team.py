# SCOPE: os-only
"""Portability proof for scripts/security-red-team."""
...
ARTIFACT = REPO_ROOT / "scripts/security-red-team"


def test_security_red_team_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
