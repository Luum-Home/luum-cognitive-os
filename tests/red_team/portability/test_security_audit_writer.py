# SCOPE: os-only
"""Portability proof for scripts/security_audit_writer.py."""
...
ARTIFACT = REPO_ROOT / "scripts/security_audit_writer.py"


def test_security_audit_writer_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
