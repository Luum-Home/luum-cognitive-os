# SCOPE: os-only
"""Portability proof for scripts/self_improvement_discipline_gate.py."""
...
ARTIFACT = REPO_ROOT / "scripts/self_improvement_discipline_gate.py"


def test_self_improvement_discipline_gate_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
