# SCOPE: os-only
"""Portability proof for hooks/_lib/semantic-search.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/semantic-search.sh"


def test_semantic_search_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
