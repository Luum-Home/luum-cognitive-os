# SCOPE: os-only
"""Portability proof for hooks/_lib/session-fs-reap.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/session-fs-reap.sh"


def test_session_fs_reap_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
