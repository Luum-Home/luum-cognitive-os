# SCOPE: os-only
"""Portability proof for hooks/session-heartbeat.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/session-heartbeat.sh"


def test_session_heartbeat_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
