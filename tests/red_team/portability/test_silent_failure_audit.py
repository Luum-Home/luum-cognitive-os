# SCOPE: os-only
"""Portability proof for scripts/silent_failure_audit.py."""
...
ARTIFACT = REPO_ROOT / "scripts/silent_failure_audit.py"


def test_silent_failure_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
