# SCOPE: os-only
"""Portability proof for hooks/_lib/singularity-suggestion.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/singularity-suggestion.sh"


def test_singularity_suggestion_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
