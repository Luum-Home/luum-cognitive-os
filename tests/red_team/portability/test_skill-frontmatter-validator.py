# SCOPE: os-only
"""Portability proof for hooks/skill-frontmatter-validator.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/skill-frontmatter-validator.sh"


def test_skill_frontmatter_validator_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
