# SCOPE: os-only
"""Portability proof for hooks/skill-post-execution-analysis.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/skill-post-execution-analysis.sh"


def test_skill_post_execution_analysis_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
