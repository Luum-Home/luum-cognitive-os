# SCOPE: os-only
"""Portability proof for hooks/skill-router-prompt-suggest.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/skill-router-prompt-suggest.sh"


def test_skill_router_prompt_suggest_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
