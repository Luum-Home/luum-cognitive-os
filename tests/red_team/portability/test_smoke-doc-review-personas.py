# SCOPE: os-only
"""Portability proof for scripts/smoke-doc-review-personas.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/smoke-doc-review-personas.sh"


def test_smoke_doc_review_personas_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
