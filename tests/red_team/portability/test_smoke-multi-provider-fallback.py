# SCOPE: os-only
"""Portability proof for scripts/smoke-multi-provider-fallback.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/smoke-multi-provider-fallback.sh"


def test_smoke_multi_provider_fallback_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
