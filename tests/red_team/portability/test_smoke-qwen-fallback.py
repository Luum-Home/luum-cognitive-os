# SCOPE: os-only
"""Portability proof for scripts/smoke-qwen-fallback.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/smoke-qwen-fallback.sh"


def test_smoke_qwen_fallback_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
