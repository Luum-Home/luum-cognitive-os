# SCOPE: os-only
"""Portability proof for scripts/so-emergency-stop.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/so-emergency-stop.sh"


def test_so_emergency_stop_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
