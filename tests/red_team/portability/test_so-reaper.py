# SCOPE: os-only
"""Portability proof for scripts/so-reaper.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/so-reaper.sh"


def test_so_reaper_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
