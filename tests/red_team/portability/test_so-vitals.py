# SCOPE: os-only
"""Portability proof for scripts/so-vitals.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/so-vitals.sh"


def test_so_vitals_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
