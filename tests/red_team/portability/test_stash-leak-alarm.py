# SCOPE: os-only
"""Portability proof for scripts/stash-leak-alarm.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/stash-leak-alarm.sh"


def test_stash_leak_alarm_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
