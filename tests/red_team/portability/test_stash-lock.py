# SCOPE: os-only
"""Portability proof for hooks/_lib/stash-lock.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/stash-lock.sh"


def test_stash_lock_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
