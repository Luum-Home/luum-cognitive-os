# SCOPE: os-only
"""Portability proof for hooks/state-retention-audit.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/state-retention-audit.sh"


def test_state_retention_audit_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
