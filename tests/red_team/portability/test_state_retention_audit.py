# SCOPE: os-only
"""Portability proof for scripts/state_retention_audit.py."""
...
ARTIFACT = REPO_ROOT / "scripts/state_retention_audit.py"


def test_state_retention_audit_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
