# SCOPE: os-only
"""Portability proof for hooks/surface-fix-detector.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/surface-fix-detector.sh"


def test_surface_fix_detector_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
