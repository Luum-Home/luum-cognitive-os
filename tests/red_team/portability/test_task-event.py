# SCOPE: os-only
"""Portability proof for hooks/_lib/task-event.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/task-event.sh"


def test_task_event_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
