# SCOPE: os-only
"""Portability proof for hooks/_lib/task-identity.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/task-identity.sh"


def test_task_identity_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
