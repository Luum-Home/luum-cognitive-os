# SCOPE: os-only
"""Portability proof for hooks/teammate-idle.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/teammate-idle.sh"


def test_teammate_idle_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
