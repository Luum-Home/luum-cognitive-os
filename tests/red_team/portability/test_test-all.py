# SCOPE: os-only
"""Portability proof for scripts/test-all.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/test-all.sh"


def test_test_all_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
