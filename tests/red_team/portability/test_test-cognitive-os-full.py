# SCOPE: os-only
"""Portability proof for scripts/test-cognitive-os-full.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/test-cognitive-os-full.sh"


def test_test_cognitive_os_full_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
