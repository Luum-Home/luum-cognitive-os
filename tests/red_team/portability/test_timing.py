# SCOPE: os-only
"""Portability proof for hooks/_lib/timing.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/timing.sh"


def test_timing_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
