# SCOPE: os-only
"""Portability proof for hooks/token-budget-monitor.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/token-budget-monitor.sh"


def test_token_budget_monitor_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
