# SCOPE: os-only
"""Portability proof for hooks/tool-loop-detector.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/tool-loop-detector.sh"


def test_tool_loop_detector_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
