# SCOPE: os-only
"""Portability proof for scripts/topology-discover.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/topology-discover.sh"


def test_topology_discover_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
