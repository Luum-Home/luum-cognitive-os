# SCOPE: os-only
"""Portability proof for hooks/trust-score-validator.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/trust-score-validator.sh"


def test_trust_score_validator_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
