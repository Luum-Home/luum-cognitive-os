# SCOPE: os-only
"""Portability proof for hooks/_lib/tuning.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/tuning.sh"


def test_tuning_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
