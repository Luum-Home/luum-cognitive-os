# SCOPE: os-only
"""Portability proof for hooks/untracked-work-preservation-guard.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/untracked-work-preservation-guard.sh"


def test_untracked_work_preservation_guard_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
