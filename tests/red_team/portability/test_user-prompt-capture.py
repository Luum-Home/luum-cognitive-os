# SCOPE: os-only
"""Portability proof for hooks/user-prompt-capture.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/user-prompt-capture.sh"


def test_user_prompt_capture_passes_unrelated_tool_from_arbitrary_project_root(tmp_path: Path) -> None:
