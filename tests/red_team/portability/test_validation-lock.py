# SCOPE: os-only
"""Portability proof for hooks/_lib/validation-lock.sh."""
...
ARTIFACT = REPO_ROOT / "hooks/_lib/validation-lock.sh"


def test_validation_lock_sources_from_arbitrary_project_root(tmp_path: Path) -> None:
