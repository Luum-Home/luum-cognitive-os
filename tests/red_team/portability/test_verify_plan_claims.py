# SCOPE: os-only
"""Portability proof for scripts/verify_plan_claims.py."""
...
ARTIFACT = REPO_ROOT / "scripts/verify_plan_claims.py"


def test_verify_plan_claims_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
