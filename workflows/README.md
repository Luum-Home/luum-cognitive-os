...
uv run python run.py feature --service wallet-go --ticket DEV-1234

# Run a bug fix pipeline
uv run python run.py bug --service bff-ninja --ticket BUG-567

# Run a database migration
uv run python run.py migration --service users-core-go --description "add transfers table"

# Deploy a service
uv run python run.py deploy --service wallet-go --env staging
