...
Usage:
  uv run .cognitive-os/workflows/run.py bug --service wallet-go --ticket BUG-567
  uv run .cognitive-os/workflows/run.py bug --service bff-ninja --ticket BUG-567 --description "Fix auth token"
