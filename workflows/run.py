...
Usage:
  uv run .cognitive-os/workflows/run.py feature --service wallet-go --ticket DEV-1234
  uv run .cognitive-os/workflows/run.py bug --service bff-ninja --ticket BUG-567
  uv run .cognitive-os/workflows/run.py migration --service users-core-go --description "add transfers table"
  uv run .cognitive-os/workflows/run.py deploy --service wallet-go --env staging
